...
uses
  ...
  ComCtrls, StdCtrls, ExtCtrls, ToolWin, ImgList, IdBaseComponent,
  IdComponent, IdTCPServer, Spin, IdThreadMgr, IdThreadMgrDefault, Menus;
...
begin
  if (Clients.Count > 0) or
     (btnServerUp.Down) then
    begin
      Action := caNone;
