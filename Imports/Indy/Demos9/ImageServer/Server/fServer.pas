...
type
  TfrmServer = class(TForm)
    ...
    procedure IdTCPServerExecute1(AThread: TIdPeerThread);
...
procedure TfrmServer.IdTCPServerExecute1(AThread: TIdPeerThread);
var
...
begin
  ...
  lstRequests.items.add('Server execute: '+Trim(S));
end;
