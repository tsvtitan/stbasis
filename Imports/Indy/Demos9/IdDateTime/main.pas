...
{ TODO:
    Add minute & hour & 24 hour support.
}
...
begin
  ...
  udDay2.Position := IdDateTimeStamp1.Day;
  ...
  udSecond2.Position := udSecond.Position;
  ...
  udHourOf24Day.Position := IdDateTimeStamp1.HourOf24Day + 1;
  ...
  lblAsRFC822.Caption := IdDateTimeStamp1.GetAsRFC882;
  lblAsISO8601Calender.Caption := IDDateTimeStamp1.GetAsISO8601Calender;
