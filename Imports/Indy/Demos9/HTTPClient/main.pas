...
type
  TForm1 = class(TForm)
    ...
    procedure HTTPWorkBegin(Sender: TComponent; AWorkMode: TWorkMode;
      const AWorkCountMax: Integer);
    procedure HTTPWorkEnd(Sender: TComponent; AWorkMode: TWorkMode);
    procedure FormClose(Sender: TObject; var Action: TCloseAction);
    procedure HTTPWork(Sender: TComponent; AWorkMode: TWorkMode;
...
procedure TForm1.HTTPWorkBegin(Sender: TComponent; AWorkMode: TWorkMode;
  const AWorkCountMax: Integer);
begin
...
procedure TForm1.HTTPWorkEnd(Sender: TComponent; AWorkMode: TWorkMode);
begin
...
procedure TForm1.HTTPWork(Sender: TComponent; AWorkMode: TWorkMode;
  const AWorkCount: Integer);
begin
