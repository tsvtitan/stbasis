...
uses
  ...
  DBTables, ComCtrls, IdAntiFreezeBase, IdAntiFreeze, syncobjs;
...
{  MT := TkbmMemTable.Create(AThread.Connection);
  with MT do
    ...
    First;
    UpdateIndexes;
    SaveToStream(AStream,[mtfSaveData, mtfSaveCalculated,mtfSaveLookup,mtfSaveNonVisible,mtfSaveBlobs,mtfSaveDef,mtfSaveIndexDef,mtfSkipRest,mtfSaveFiltered,mtfSaveInLocalFormat]);
    end;
