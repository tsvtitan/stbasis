...
uses
  ...
  {$ENDIF}
  SysUtils, Classes, IdSMTP, IdComponent, IdTCPConnection, IdTCPClient,
  IdMessageClient, IdPOP3, IdBaseComponent, IdMessage, IdAntiFreezeBase,
  IdAntiFreeze,   QActnList,   QImgList,   QTypes,   QButtons;
...
begin
  ...
  ReadConfiguration;
   ...
   FAttachPath := ExtractFilePath(Application.exename); //starting directory
