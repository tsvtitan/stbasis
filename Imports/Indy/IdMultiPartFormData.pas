...
const
  ...
  sFileNamePlaceHolder = '; filename="';
  sContentTypePlaceHolder = 'Content-Type: ';
...
procedure TIdMultiPartFormDataStream.AddStreamAsFile(const AFieldName, AFileName, AContentType: string; AStream: TStream);
var
  FItem: TIdFormDataField;
begin
  FItem := FFields.Add;
  ...
  begin
    with AItem do begin
      result := '--' + Boundary + crlf + sContentDisposition + FieldName + '"' +
        ...
        sContentTypePlaceHolder + ContentType + crlf + crlf;
    end;
  end;
