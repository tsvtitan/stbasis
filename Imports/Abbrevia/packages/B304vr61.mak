...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = B304vr61.bpl
OBJFILES = B304vr61.obj ..\source\AbCView.obj ..\source\AbMeter.obj \
    ..\source\Abview.obj ..\source\AbZipOut.obj ..\source\AbZView.obj \
    ..\source\AbBseVCL.obj ..\source\AbCompnd.obj ..\source\AbHexVw.obj
RESFILES = B304vr61.res
MAINSOURCE = B304vr61.cpp
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
...
PACKAGES = vclx.bpi vcl.bpi rtl.bpi B304_r61.bpi
...
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower Abbrevia 3.04 Run-time package - VCL61" -aa -Tpp -Gpr -x -Gn \
    -Gl -Gi -w
# ---------------------------------------------------------------------------
