...
OBJFILES = ..\source\Abarctyp.obj ..\source\AbBase.obj ..\source\AbBitBkt.obj \
    ...
    ..\source\AbZipPrc.obj ..\source\Abziptyp.obj ..\source\AbZView.obj \
    B305_r51.obj
RESFILES = B305_r51.res
MAINSOURCE = B305_r51.cpp
...
PFLAGS = -$YD -$L- -$D- -v -M -JPHNE
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower Abbrevia 3.05 Run-time package - VCL51" -aa -Tpp -Gpr -x -Gn \
    -Gl -Gi -w
# ---------------------------------------------------------------------------
