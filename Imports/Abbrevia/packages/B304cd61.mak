...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = B304cd61.bpl
OBJFILES = B304cd61.obj ..\source\AbRegClx.obj ..\source\AbQPeCol.obj \
    ..\source\AbQPeVer.obj ..\source\AbQDgPwd.obj ..\source\AbQPeDir.obj \
    ..\source\AbQPeFn.obj ..\source\AbQPePas.obj ..\source\AbQDgDir.obj
RESFILES = B304cd61.res
MAINSOURCE = B304cd61.cpp
RESDEPEN = $(RESFILES) ..\source\AbQPeCol.dfm ..\source\AbQPeVer.dfm
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
PACKAGES = designide.bpi designdgm.bpi B304cr61.bpi rtl.bpi
SPARELIBS = rtl.lib
DEFFILE = 
OTHERFILES = 
# ---------------------------------------------------------------------------
...
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower Abbrevia 3.04 CLX Design-time package - CLX61" -aa -Tpp -Gpd \
    -x -Gn -Gl -Gi -w
# ---------------------------------------------------------------------------
