...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = B305_r61.bpl
OBJFILES = B305_r61.obj ..\source\Abarctyp.obj ..\source\AbBase.obj \
    ...
    ..\source\AbZLTyp.obj
RESFILES = B305_r61.res
MAINSOURCE = B305_r61.cpp
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
...
RFLAGS = 
AFLAGS = /mx /w2 /zn
LFLAGS = -D"TurboPower Abbrevia 3.05 Run-time package - RTL61" -aa -Tpp -Gpr -x -Gn \
    -Gl -Gi -w
# ---------------------------------------------------------------------------
