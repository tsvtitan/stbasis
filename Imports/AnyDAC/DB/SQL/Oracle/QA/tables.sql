...
DROP TABLE "ADQA_Clob"
/

CREATE TABLE "ADQA_Clob" (
  id    NUMBER(10,0) NOT NULL,
  blobdata  CLOB NULL
)
/
...
DROP TABLE "ADQA_LongRaw"
/

CREATE TABLE "ADQA_LongRaw" (
  id    NUMBER(10,0) NOT NULL,
...
DROP TABLE "ADQA_NumbersPrec"
/

CREATE TABLE "ADQA_NumbersPrec" (
   n__   number,
   n_0   number(*,0),
   n40   number(4,0),
   n50   number(5,0),
...
INSERT INTO "ADQA_NumbersPrec" VALUES (
...
-- INSERT INTO ADQA_NumbersPrec (n4_) VALUES (123.4)
-- INSERT INTO ADQA_NumbersPrec (n4_) VALUES (1234.5)
-- INSERT INTO ADQA_NumbersPrec (n4_) VALUES (12345.6)
-- INSERT INTO ADQA_NumbersPrec (n__) VALUES (1234567890.1234567890)
-- SELECT n__ FROM ADQA_NumbersPrec
-- SELECT * FROM ADQA_NumbersPrec
-- SELECT * FROM all_tab_columns WHERE table_name = 'ADQA_NumbersPrec'
...
DROP TABLE "ADQA_All_types_DTM"
/

CREATE TABLE "ADQA_All_types_DTM" (
  tnvarchar2 NVARCHAR2(2000) NULL,
  tvarchar2  VARCHAR2(15)    NULL,
  tnumber    NUMBER          NULL,
  tfloat     FLOAT(126)      NULL,
