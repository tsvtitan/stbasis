...
if WScript.Arguments.Count <> 1 then
  WScript.Echo "usage: tables.vbs <path to ADDemo.mdb>"
  WScript.Quit
end if

sFile = WScript.Arguments.Item(0) & "\" & "ADDemo.mdb"
...
Set oTableDef = oDatabase.CreateTableDef("ADQA_All_types")
...
Set oTableDef = oDatabase.CreateTableDef("ADQA_DB_types")
...
'Table Ascii_types
Set oTableDef = oDatabase.CreateTableDef("ADQA_Ascii_types")
...
Set oTableDef = oDatabase.CreateTableDef("ADQA_Numbers")
...
Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q1", "CREATE TABLE ADQA_master_autoinc(id1 counter constraint [PK_master_autoinc] primary key, name1 varchar(20));")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q2", "CREATE TABLE ADQA_details_autoinc(id2 counter constraint [PK_details_autoinc] primary key, fk_id1 integer, name2 varchar(20));")
oQueryDef.Execute

'  CREATE RELATIONSHIP "FK_master_details_auto"
Set oRelation = oDatabase.CreateRelation("FK_detailsautoinc_masterautoinc", "ADQA_master_autoinc", "ADQA_details_autoinc")
...
Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q3", "CREATE TABLE ADQA_LockTable (id int NOT NULL, name varchar (100) NOT NULL)")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q4", "CREATE TABLE ADQA_NoValsTable (id int, name varchar (100))")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q5", "CREATE TABLE ADQA_TransTable (id int constraint [PK_TransTable] primary key, name varchar (100))")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q6", "CREATE TABLE ADQA_TabWithPK(f1 int constraint [PK_TabWithPK] primary key);")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q7", "CREATE TABLE ADQA_Batch_test(tint int, tstring text, tblob OLEObject);")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q8", "CREATE TABLE ADQA_MaxLength(str text, memos memo, widestr text, blobs OLEObject);")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q9", "CREATE TABLE ADQA_Blob(id1 counter, blobdata OLEObject);")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q10", "CREATE TABLE ADQA_ForAsync(id int NULL, name varchar (20) NULL);")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q11", "CREATE TABLE ADQA_ParamBind(p1 varchar (50) NULL, p2 varchar (50) NULL, p3 varchar (50) NULL, p4 varchar (50) NULL);")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q12", "CREATE TABLE ADQA_map1(id1 int, name1 varchar (20) NULL);")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q13", "CREATE TABLE ADQA_map2(id2 int, name2 varchar (20) NULL);")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q14", "CREATE TABLE ADQA_map3(id3 int, name3 varchar (20) NULL);")
oQueryDef.Execute

Set oQueryDef = oDatabase.CreateQueryDef("ADQA_q15", "CREATE TABLE ADQA_map4(id4 int, name4 varchar (20) NULL);")
oQueryDef.Execute

i = 1
Do While i < 15
 oDatabase.QueryDefs.Delete("ADQA_q" & i)
 i = i + 1
Loop
