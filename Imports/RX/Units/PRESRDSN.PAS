...
uses
  ...
  Buttons, ExtCtrls, RXCtrls, Placemnt, RXProps, Consts, DsgnIntf, VclUtils;
...
{$IFDEF WIN32}
uses Windows, BoxProcs, TypInfo, RXLConst;
{$ELSE}
uses WinTypes, WinProcs, Str16, BoxProcs, TypInfo, RXLConst;
{$ENDIF}
