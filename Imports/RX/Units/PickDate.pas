...
uses Messages, {$IFDEF WIN32} Windows, {$ELSE} WinTypes, WinProcs, {$ENDIF} Classes,
  Controls, SysUtils, Graphics, DateUtil, Grids;
...
uses Consts, Forms, Buttons, StdCtrls, ExtCtrls, RXCtrls,
