...
#ifdef DEMO
  #define AppName "Недвижимость Демо"
  #define OutputBaseFilename "premises_demo_"+AppVersion
  #define AppID "{{52721DB5-08D8-4F17-996D-0FA9DE861156}"
...
#else
  #define AppName "Недвижимость"
  #define OutputBaseFilename "premises_"+AppVersion
  #define AppID "{{66804DCA-4590-4127-891E-304E4D55D97A}"
...
Source: files\premises.dll; DestDir: {app}; Flags: replacesameversion; Components: client
...
Source: files\premises.db; DestDir: {app}; Flags: onlyifdoesntexist; Components: client
#ifdef ADMIN_MODULE
...
#endif
Source: files\stbasis.log; DestDir: {app}; Flags: onlyifdoesntexist
...
Name: {userprograms}\{#AppPublisher}\{#AppName}\Удаление {#AppName}; Filename: {uninstallexe}; WorkingDir: {app}; IconFilename: {uninstallexe}; Components: client
...
[Components]
Name: client; Description: Программа {#AppName} {#AppVersion} (Базовая+Реклама); Types: full; Flags: fixed
...
#ifdef DEMO
Filename: {app}\stbasis.exe; Parameters: /runcount true 50; WorkingDir: {app}; Flags: runhidden waituntilidle; Components: client
#endif
