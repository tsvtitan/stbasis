...
const
  ...
  LibraryHint='Содержит справочники и отчеты необходимые для формирования объявлений связанных с недвижимостью.';
  ...
  SInvalidFormat='Неверный формат';
  SSaveFieldView='Сохранить текущее представление?';
  SExcelExtension='.xls';
  STextExtension='.txt';
  SPreviewImportFilter='Файлы Excel (*.xls)|*.xls|Текстовые файлы (*.txt)|*.txt';
  SPreviewFilter='XML файлы (*.xml)|*.xml';
  SPreviewRubricator='TXT файлы (*.txt)|*.txt';
  SPreviewDefaultExt='.xml';
  SPreviewRubricatorExt='.txt';
  SPreviewCaption='Предварительный просмотр';
  ...
  ConstsMenuRBooksPremises='Недвижимость';
  ConstsMenuOptsPremises=ConstsMenuRBooksPremises;

  NameRbkAPTypePremises='Справочник типов недвижимости';
  NameRbkAPTypeInternet='Справочник видов интернета';
  NameRbkAPBuilder='Справочник застройщиков';
  NameRbkAPTypeWater='Справочник видов водоснабжения';
  NameRbkAPTypeHeat='Справочник видов отопления';
  NameRbkAPTypeSanitary='Справочник видов санузла';
  NameRbkAPTown='Справочник городов';
  NameRbkAPRegion='Справочник районов';
  NameRbkAPStreet='Справочник улиц';
  NameRbkAPTypePhone='Справочник видов телефона';
  NameRbkAPCountRoom='Справочник количества комнат';
  NameRbkAPTypeBuilding='Справочник типов дома';
  NameRbkAPTypeApartment='Справочник типов квартиры';
  NameRbkAPPlanning='Справочник планировок';
  NameRbkAPTypeBalcony='Справочник видов балкона';
  NameRbkAPTypeGarage='Справочник типов гаража';
  NameRbkAPTypeBath='Справочник типов бани';
  NameRbkAPTypeSewerage='Справочник видов канализации';
  NameRbkAPStyle='Справочник стилей';
  NameRbkAPUnitPrice='Справочник единиц измерения цены';
  NameRbkAPTypeCondition='Справочник видов состояния';
  NameRbkAPTypePlate='Справочник видов плиты';
  NameRbkAPTypeFurniture='Справочник видов мебели';
  NameRbkAPTypeDoor='Справочник видов двери';
  NameRbkAPHomeTech='Справочник бытовой техники';
  NameRbkAPFieldView='Справочник представлений';
  NameRbkAPAgency='Справочник агентств';
  NameRbkAPOperation='Справочник операций с недвижимостью';
  NameRbkAPLandMark='Справочник ориентиров';
  NameRbkAPDirection='Справочник направлений';
  NameRbkAPRegionStreet='Справочник улиц районов';
  NameRbkAPPremises='Объявления недвижимости';
  NameSrvImportPremises='Импорт недвижимости';
