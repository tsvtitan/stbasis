...
begin
  ...
  CreateInterpreterFunLocal('CreateDocumentByName',Self_CreateDocumentByName,ArrPP(['const Name',varString,'Visible: Boolean=false',varBoolean]),PP('Variant',varVariant),'Создать документ по имени');
  CreateInterpreterFunLocal('GetInterfaceName',Self_GetInterfaceName,nil,PP('String',varString),'Получить имя интерфейса');
end;
//********************* end of Internal *****************
