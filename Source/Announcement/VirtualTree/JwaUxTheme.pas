...
begin
  ...
  begin
    ...
    ThemesAvailable := ThemeLibrary > 0;
...
begin
  {$undef FullEvaluation}
  {$ifopt B+} {$Booleval off} {$define FullEvaluation} {$endif}
    Result := ThemesAvailable and IsAppThemed and IsThemeActive;
  {$ifdef FullEvaluation} {$Booleval on} {$undef FullEvaluation} {$endif}
end;
