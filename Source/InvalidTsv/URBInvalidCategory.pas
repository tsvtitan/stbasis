...
type
   TfmRBInvalidCategory = class(TfmRBMainGrid)
...
var
  fmRBInvalidCategory: TfmRBInvalidCategory;
...
procedure TfmRBInvalidCategory.FormCreate(Sender: TObject);
var
  cl: TColumn;
begin
 inherited;
...
procedure TfmRBInvalidCategory.FormDestroy(Sender: TObject);
begin
  inherited;
...
function TfmRBInvalidCategory.GetSql: string;
begin
...
procedure TfmRBInvalidCategory.ActiveQuery(CheckPerm: Boolean);
var
 sqls: String;
begin
 try
...
procedure TfmRBInvalidCategory.GridTitleClickWithSort(Column: TColumn; TypeSort: TTypeColumnSort);
var
  fn: string;
  id: string;
begin
...
procedure TfmRBInvalidCategory.GridDblClick(Sender: TObject);
begin
  if not Mainqr.Active then exit;
...
procedure TfmRBInvalidCategory.LoadFromIni;
begin
 inherited;
 try
...
procedure TfmRBInvalidCategory.SaveToIni;
begin
 inherited;
 try
...
procedure TfmRBInvalidCategory.bibRefreshClick(Sender: TObject);
begin
  ActiveQuery(true);
end;

procedure TfmRBInvalidCategory.bibAddClick(Sender: TObject);
var
...
procedure TfmRBInvalidCategory.bibChangeClick(Sender: TObject);
var
  fm: TfmEditRBInvalidCategory;
begin
  if not Mainqr.Active then exit;
...
procedure TfmRBInvalidCategory.bibDelClick(Sender: TObject);
var
  but: Integer;
...
procedure TfmRBInvalidCategory.bibViewClick(Sender: TObject);
var
  fm: TfmEditRBInvalidCategory;
begin
  if not Mainqr.Active then exit;
...
procedure TfmRBInvalidCategory.bibFilterClick(Sender: TObject);
var
  fm: TfmEditRBInvalidCategory;
  filstr: string;
begin
...
function TfmRBInvalidCategory.GetFilterString: string;
var
  FilInSide: string;
  wherestr: string;
