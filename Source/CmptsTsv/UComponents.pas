...
uses Classes,
     ...
     daADCompClient, daADStanIntf, daADCompDataSet,
     daADPhysManager, daADPhysMySQL, daADGUIxFormsWait
...
type
   ...
   TiADManager=class(TADManager)
   end;

   TiADConnection=class(TADConnection)
   end;

   TiADQuery=class(TADQuery)
   end;

   TiADTable=class(TADTable)
   end;
