...
begin
  ...
  CreateDesignPaletteButtonLocal(DPH,'Соединение',TiADConnection,1,dm.ILAnyDac);
  CreateDesignPaletteButtonLocal(DPH,'Запрос',TiADQuery,2,dm.ILAnyDac);
  CreateDesignPaletteButtonLocal(DPH,'Таблица',TiADTable,3,dm.ILAnyDac);
