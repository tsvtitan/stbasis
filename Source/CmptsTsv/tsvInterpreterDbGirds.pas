...
uses SysUtils, UMainUnited, tsvInterpreterCore;
  ...
  { TColumnTitle }
procedure TColumnTitle_Create(var Value: Variant; Args: TArguments);
procedure TColumnTitle_Assign(var Value: Variant; Args: TArguments);
procedure TColumnTitle_DefaultAlignment(var Value: Variant; Args: TArguments);
procedure TColumnTitle_DefaultColor(var Value: Variant; Args: TArguments);
procedure TColumnTitle_DefaultFont(var Value: Variant; Args: TArguments);
procedure TColumnTitle_DefaultCaption(var Value: Variant; Args: TArguments);
procedure TColumnTitle_RestoreDefaults(var Value: Variant; Args: TArguments);
procedure TColumnTitle_Read_Alignment(var Value: Variant; Args: TArguments);
procedure TColumnTitle_Write_Alignment(const Value: Variant; Args: TArguments);
procedure TColumnTitle_Read_Caption(var Value: Variant; Args: TArguments);
procedure TColumnTitle_Write_Caption(const Value: Variant; Args: TArguments);
procedure TColumnTitle_Read_Color(var Value: Variant; Args: TArguments);
procedure TColumnTitle_Write_Color(const Value: Variant; Args: TArguments);
procedure TColumnTitle_Read_Font(var Value: Variant; Args: TArguments);
procedure TColumnTitle_Write_Font(const Value: Variant; Args: TArguments);

  { TColumn }
procedure TColumn_Create(var Value: Variant; Args: TArguments);
procedure TColumn_Assign(var Value: Variant; Args: TArguments);
procedure TColumn_DefaultAlignment(var Value: Variant; Args: TArguments);
procedure TColumn_DefaultColor(var Value: Variant; Args: TArguments);
procedure TColumn_DefaultFont(var Value: Variant; Args: TArguments);
procedure TColumn_DefaultImeMode(var Value: Variant; Args: TArguments);
procedure TColumn_DefaultImeName(var Value: Variant; Args: TArguments);
procedure TColumn_DefaultReadOnly(var Value: Variant; Args: TArguments);
procedure TColumn_DefaultWidth(var Value: Variant; Args: TArguments);
procedure TColumn_RestoreDefaults(var Value: Variant; Args: TArguments);
procedure TColumn_Read_Grid(var Value: Variant; Args: TArguments);
procedure TColumn_Read_AssignedValues(var Value: Variant; Args: TArguments);
procedure TColumn_Read_Field(var Value: Variant; Args: TArguments);
procedure TColumn_Write_Field(const Value: Variant; Args: TArguments);
procedure TColumn_Read_Alignment(var Value: Variant; Args: TArguments);
procedure TColumn_Write_Alignment(const Value: Variant; Args: TArguments);
procedure TColumn_Read_ButtonStyle(var Value: Variant; Args: TArguments);
procedure TColumn_Write_ButtonStyle(const Value: Variant; Args: TArguments);
procedure TColumn_Read_Color(var Value: Variant; Args: TArguments);
procedure TColumn_Write_Color(const Value: Variant; Args: TArguments);
procedure TColumn_Read_DropDownRows(var Value: Variant; Args: TArguments);
procedure TColumn_Write_DropDownRows(const Value: Variant; Args: TArguments);
procedure TColumn_Read_FieldName(var Value: Variant; Args: TArguments);
procedure TColumn_Write_FieldName(const Value: Variant; Args: TArguments);
procedure TColumn_Read_Font(var Value: Variant; Args: TArguments);
procedure TColumn_Write_Font(const Value: Variant; Args: TArguments);
procedure TColumn_Read_ImeMode(var Value: Variant; Args: TArguments);
procedure TColumn_Write_ImeMode(const Value: Variant; Args: TArguments);
procedure TColumn_Read_ImeName(var Value: Variant; Args: TArguments);
procedure TColumn_Write_ImeName(const Value: Variant; Args: TArguments);
procedure TColumn_Read_PickList(var Value: Variant; Args: TArguments);
procedure TColumn_Write_PickList(const Value: Variant; Args: TArguments);
procedure TColumn_Read_PopupMenu(var Value: Variant; Args: TArguments);
procedure TColumn_Write_PopupMenu(const Value: Variant; Args: TArguments);
procedure TColumn_Read_ReadOnly(var Value: Variant; Args: TArguments);
procedure TColumn_Write_ReadOnly(const Value: Variant; Args: TArguments);
procedure TColumn_Read_Title(var Value: Variant; Args: TArguments);
procedure TColumn_Write_Title(const Value: Variant; Args: TArguments);
procedure TColumn_Read_Width(var Value: Variant; Args: TArguments);
procedure TColumn_Write_Width(const Value: Variant; Args: TArguments);

  { TDBGridColumns }
procedure TDBGridColumns_Create(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_Add(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_LoadFromFile(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_LoadFromStream(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_RestoreDefaults(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_RebuildColumns(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_SaveToFile(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_SaveToStream(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_Read_State(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_Write_State(const Value: Variant; Args: TArguments);
procedure TDBGridColumns_Read_Grid(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_Read_Items(var Value: Variant; Args: TArguments);
procedure TDBGridColumns_Write_Items(const Value: Variant; Args: TArguments);

  { TBookmarkList }
procedure TBookmarkList_Create(var Value: Variant; Args: TArguments);
procedure TBookmarkList_Clear(var Value: Variant; Args: TArguments);
procedure TBookmarkList_Delete(var Value: Variant; Args: TArguments);
procedure TBookmarkList_Find(var Value: Variant; Args: TArguments);
procedure TBookmarkList_IndexOf(var Value: Variant; Args: TArguments);
procedure TBookmarkList_Refresh(var Value: Variant; Args: TArguments);
procedure TBookmarkList_Read_Count(var Value: Variant; Args: TArguments);
procedure TBookmarkList_Read_CurrentRowSelected(var Value: Variant; Args: TArguments);
procedure TBookmarkList_Write_CurrentRowSelected(const Value: Variant; Args: TArguments);
procedure TBookmarkList_Read_Items(var Value: Variant; Args: TArguments);

  { TCustomDBGrid }
procedure TCustomDBGrid_ValidFieldIndex(var Value: Variant; Args: TArguments);
procedure TCustomDBGrid_Read_FieldCount(var Value: Variant; Args: TArguments);
procedure TCustomDBGrid_Read_Fields(var Value: Variant; Args: TArguments);
procedure TCustomDBGrid_Read_SelectedField(var Value: Variant; Args: TArguments);
procedure TCustomDBGrid_Write_SelectedField(const Value: Variant; Args: TArguments);
procedure TCustomDBGrid_Read_SelectedIndex(var Value: Variant; Args: TArguments);
procedure TCustomDBGrid_Write_SelectedIndex(const Value: Variant; Args: TArguments);

  { TDBGrid }
procedure TDBGrid_Create(var Value: Variant; Args: TArguments);

implementation

uses Classes, Graphics, Menus, Grids, Db, DbGrids;
