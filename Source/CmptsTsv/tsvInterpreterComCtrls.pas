unit tsvInterpreterComCtrls;

interface

uses ComCtrls, UMainUnited, tsvInterpreterCore;


  { TTabControl }
procedure TTabControl_Create(var Value: Variant; Args: TArguments);

  { TTabSheet }
procedure TTabSheet_Create(var Value: Variant; Args: TArguments);
procedure TTabSheet_Read_PageControl(var Value: Variant; Args: TArguments);
procedure TTabSheet_Write_PageControl(const Value: Variant; Args: TArguments);
procedure TTabSheet_Read_TabIndex(var Value: Variant; Args: TArguments);

  { TPageControl }
procedure TPageControl_Create(var Value: Variant; Args: TArguments);
procedure TPageControl_FindNextPage(var Value: Variant; Args: TArguments);
procedure TPageControl_SelectNextPage(var Value: Variant; Args: TArguments);
procedure TPageControl_Read_PageCount(var Value: Variant; Args: TArguments);
procedure TPageControl_Read_Pages(var Value: Variant; Args: TArguments);

  { TStatusPanel }
procedure TStatusPanel_Create(var Value: Variant; Args: TArguments);
procedure TStatusPanel_Assign(var Value: Variant; Args: TArguments);

  { TStatusPanels }
procedure TStatusPanels_Create(var Value: Variant; Args: TArguments);
procedure TStatusPanels_Add(var Value: Variant; Args: TArguments);
procedure TStatusPanels_Read_Items(var Value: Variant; Args: TArguments);
procedure TStatusPanels_Write_Items(const Value: Variant; Args: TArguments);

  { TStatusBar }
procedure TStatusBar_Create(var Value: Variant; Args: TArguments);
procedure TStatusBar_Read_Canvas(var Value: Variant; Args: TArguments);

  { THeaderSection }
procedure THeaderSection_Create(var Value: Variant; Args: TArguments);
procedure THeaderSection_Assign(var Value: Variant; Args: TArguments);
procedure THeaderSection_Read_Left(var Value: Variant; Args: TArguments);
procedure THeaderSection_Read_Right(var Value: Variant; Args: TArguments);

  { THeaderSections }
procedure THeaderSections_Create(var Value: Variant; Args: TArguments);
procedure THeaderSections_Add(var Value: Variant; Args: TArguments);
procedure THeaderSections_Read_Items(var Value: Variant; Args: TArguments);
procedure THeaderSections_Write_Items(const Value: Variant; Args: TArguments);

  { THeaderControl }
procedure THeaderControl_Create(var Value: Variant; Args: TArguments);
procedure THeaderControl_Read_Canvas(var Value: Variant; Args: TArguments);

  { TTreeNode }
procedure TTreeNode_Create(var Value: Variant; Args: TArguments);
procedure TTreeNode_AlphaSort(var Value: Variant; Args: TArguments);
procedure TTreeNode_Assign(var Value: Variant; Args: TArguments);
procedure TTreeNode_Collapse(var Value: Variant; Args: TArguments);
procedure TTreeNode_Delete(var Value: Variant; Args: TArguments);
procedure TTreeNode_DeleteChildren(var Value: Variant; Args: TArguments);
procedure TTreeNode_EditText(var Value: Variant; Args: TArguments);
procedure TTreeNode_EndEdit(var Value: Variant; Args: TArguments);
procedure TTreeNode_Expand(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetFirstChild(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetHandle(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetLastChild(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetNext(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetNextChild(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetNextSibling(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetNextVisible(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetPrev(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetPrevChild(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetPrevSibling(var Value: Variant; Args: TArguments);
procedure TTreeNode_GetPrevVisible(var Value: Variant; Args: TArguments);
procedure TTreeNode_HasAsParent(var Value: Variant; Args: TArguments);
procedure TTreeNode_IndexOf(var Value: Variant; Args: TArguments);
procedure TTreeNode_MakeVisible(var Value: Variant; Args: TArguments);
procedure TTreeNode_MoveTo(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_AbsoluteIndex(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Count(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Cut(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_Cut(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Data(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_Data(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Deleting(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Focused(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_Focused(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_DropTarget(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_DropTarget(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Selected(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_Selected(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Expanded(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_Expanded(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Handle(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_HasChildren(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_HasChildren(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_ImageIndex(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_ImageIndex(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Index(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_IsVisible(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Item(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_Item(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_ItemId(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Level(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_OverlayIndex(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_OverlayIndex(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Owner(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Parent(var Value: Variant; Args: TArguments);
procedure TTreeNode_Read_SelectedIndex(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_SelectedIndex(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_StateIndex(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_StateIndex(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_Text(var Value: Variant; Args: TArguments);
procedure TTreeNode_Write_Text(const Value: Variant; Args: TArguments);
procedure TTreeNode_Read_TreeView(var Value: Variant; Args: TArguments);

  { TTreeNodes }
procedure TTreeNodes_Create(var Value: Variant; Args: TArguments);
procedure TTreeNodes_AddChildFirst(var Value: Variant; Args: TArguments);
procedure TTreeNodes_AddChild(var Value: Variant; Args: TArguments);
procedure TTreeNodes_AddChildObjectFirst(var Value: Variant; Args: TArguments);
procedure TTreeNodes_AddChildObject(var Value: Variant; Args: TArguments);
procedure TTreeNodes_AddFirst(var Value: Variant; Args: TArguments);
procedure TTreeNodes_Add(var Value: Variant; Args: TArguments);
procedure TTreeNodes_AddObjectFirst(var Value: Variant; Args: TArguments);
procedure TTreeNodes_AddObject(var Value: Variant; Args: TArguments);
procedure TTreeNodes_Assign(var Value: Variant; Args: TArguments);
procedure TTreeNodes_BeginUpdate(var Value: Variant; Args: TArguments);
procedure TTreeNodes_Clear(var Value: Variant; Args: TArguments);
procedure TTreeNodes_Delete(var Value: Variant; Args: TArguments);
procedure TTreeNodes_EndUpdate(var Value: Variant; Args: TArguments);
procedure TTreeNodes_GetFirstNode(var Value: Variant; Args: TArguments);
procedure TTreeNodes_GetNode(var Value: Variant; Args: TArguments);
procedure TTreeNodes_Insert(var Value: Variant; Args: TArguments);
procedure TTreeNodes_InsertObject(var Value: Variant; Args: TArguments);
procedure TTreeNodes_Read_Count(var Value: Variant; Args: TArguments);
procedure TTreeNodes_Read_Handle(var Value: Variant; Args: TArguments);
procedure TTreeNodes_Read_Item(var Value: Variant; Args: TArguments);
procedure TTreeNodes_Read_Owner(var Value: Variant; Args: TArguments);

  { TCustomTreeView }
procedure TCustomTreeView_AlphaSort(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_FullCollapse(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_FullExpand(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_GetHitTestInfoAt(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_GetNodeAt(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_IsEditing(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_LoadFromFile(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_LoadFromStream(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_SaveToFile(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_SaveToStream(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_Read_DropTarget(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_Write_DropTarget(const Value: Variant; Args: TArguments);
procedure TCustomTreeView_Read_Selected(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_Write_Selected(const Value: Variant; Args: TArguments);
procedure TCustomTreeView_Read_TopItem(var Value: Variant; Args: TArguments);
procedure TCustomTreeView_Write_TopItem(const Value: Variant; Args: TArguments);

  { TTreeView }
procedure TTreeView_Create(var Value: Variant; Args: TArguments);

  { TTrackBar }
procedure TTrackBar_Create(var Value: Variant; Args: TArguments);
procedure TTrackBar_SetTick(var Value: Variant; Args: TArguments);

  { TProgressBar }
procedure TProgressBar_Create(var Value: Variant; Args: TArguments);
procedure TProgressBar_StepIt(var Value: Variant; Args: TArguments);
procedure TProgressBar_StepBy(var Value: Variant; Args: TArguments);

  { TTextAttributes }
procedure TTextAttributes_Create(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Assign(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Read_Charset(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Write_Charset(const Value: Variant; Args: TArguments);
procedure TTextAttributes_Read_Color(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Write_Color(const Value: Variant; Args: TArguments);
procedure TTextAttributes_Read_ConsistentAttributes(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Read_Name(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Write_Name(const Value: Variant; Args: TArguments);
procedure TTextAttributes_Read_Pitch(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Write_Pitch(const Value: Variant; Args: TArguments);
procedure TTextAttributes_Read_Protected(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Write_Protected(const Value: Variant; Args: TArguments);
procedure TTextAttributes_Read_Size(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Write_Size(const Value: Variant; Args: TArguments);
procedure TTextAttributes_Read_Style(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Write_Style(const Value: Variant; Args: TArguments);
procedure TTextAttributes_Read_Height(var Value: Variant; Args: TArguments);
procedure TTextAttributes_Write_Height(const Value: Variant; Args: TArguments);

  { TParaAttributes }
procedure TParaAttributes_Create(var Value: Variant; Args: TArguments);
procedure TParaAttributes_Assign(var Value: Variant; Args: TArguments);
procedure TParaAttributes_Read_Alignment(var Value: Variant; Args: TArguments);
procedure TParaAttributes_Write_Alignment(const Value: Variant; Args: TArguments);
procedure TParaAttributes_Read_FirstIndent(var Value: Variant; Args: TArguments);
procedure TParaAttributes_Write_FirstIndent(const Value: Variant; Args: TArguments);
procedure TParaAttributes_Read_LeftIndent(var Value: Variant; Args: TArguments);
procedure TParaAttributes_Write_LeftIndent(const Value: Variant; Args: TArguments);
procedure TParaAttributes_Read_Numbering(var Value: Variant; Args: TArguments);
procedure TParaAttributes_Write_Numbering(const Value: Variant; Args: TArguments);
procedure TParaAttributes_Read_RightIndent(var Value: Variant; Args: TArguments);
procedure TParaAttributes_Write_RightIndent(const Value: Variant; Args: TArguments);
procedure TParaAttributes_Read_Tab(var Value: Variant; Args: TArguments);
procedure TParaAttributes_Write_Tab(const Value: Variant; Args: TArguments);
procedure TParaAttributes_Read_TabCount(var Value: Variant; Args: TArguments);
procedure TParaAttributes_Write_TabCount(const Value: Variant; Args: TArguments);

  { TCustomRichEdit }
procedure TCustomRichEdit_Clear(var Value: Variant; Args: TArguments);
procedure TCustomRichEdit_FindText(var Value: Variant; Args: TArguments);
procedure TCustomRichEdit_GetSelTextBuf(var Value: Variant; Args: TArguments);
procedure TCustomRichEdit_Print(var Value: Variant; Args: TArguments);
procedure TCustomRichEdit_Read_DefAttributes(var Value: Variant; Args: TArguments);
procedure TCustomRichEdit_Write_DefAttributes(const Value: Variant; Args: TArguments);
procedure TCustomRichEdit_Read_SelAttributes(var Value: Variant; Args: TArguments);
procedure TCustomRichEdit_Write_SelAttributes(const Value: Variant; Args: TArguments);
procedure TCustomRichEdit_Read_Paragraph(var Value: Variant; Args: TArguments);

  { TRichEdit }
procedure TRichEdit_Create(var Value: Variant; Args: TArguments);

  { TUpDown }
procedure TUpDown_Create(var Value: Variant; Args: TArguments);

  { THotKey }
procedure THotKey_Create(var Value: Variant; Args: TArguments);

  { TListColumn }
procedure TListColumn_Create(var Value: Variant; Args: TArguments);
procedure TListColumn_Assign(var Value: Variant; Args: TArguments);
procedure TListColumn_Read_WidthType(var Value: Variant; Args: TArguments);

  { TListColumns }
procedure TListColumns_Create(var Value: Variant; Args: TArguments);
procedure TListColumns_Add(var Value: Variant; Args: TArguments);
procedure TListColumns_Read_Owner(var Value: Variant; Args: TArguments);
procedure TListColumns_Read_Items(var Value: Variant; Args: TArguments);
procedure TListColumns_Write_Items(const Value: Variant; Args: TArguments);

  { TListItem }
procedure TListItem_Create(var Value: Variant; Args: TArguments);
procedure TListItem_CancelEdit(var Value: Variant; Args: TArguments);
procedure TListItem_Delete(var Value: Variant; Args: TArguments);
procedure TListItem_EditCaption(var Value: Variant; Args: TArguments);
procedure TListItem_MakeVisible(var Value: Variant; Args: TArguments);
procedure TListItem_Update(var Value: Variant; Args: TArguments);
procedure TListItem_Read_Caption(var Value: Variant; Args: TArguments);
procedure TListItem_Write_Caption(const Value: Variant; Args: TArguments);
procedure TListItem_Read_Checked(var Value: Variant; Args: TArguments);
procedure TListItem_Write_Checked(const Value: Variant; Args: TArguments);
procedure TListItem_Read_Cut(var Value: Variant; Args: TArguments);
procedure TListItem_Write_Cut(const Value: Variant; Args: TArguments);
procedure TListItem_Read_Data(var Value: Variant; Args: TArguments);
procedure TListItem_Write_Data(const Value: Variant; Args: TArguments);
procedure TListItem_Read_DropTarget(var Value: Variant; Args: TArguments);
procedure TListItem_Write_DropTarget(const Value: Variant; Args: TArguments);
procedure TListItem_Read_Focused(var Value: Variant; Args: TArguments);
procedure TListItem_Write_Focused(const Value: Variant; Args: TArguments);
procedure TListItem_Read_Handle(var Value: Variant; Args: TArguments);
procedure TListItem_Read_ImageIndex(var Value: Variant; Args: TArguments);
procedure TListItem_Write_ImageIndex(const Value: Variant; Args: TArguments);
procedure TListItem_Read_Index(var Value: Variant; Args: TArguments);
procedure TListItem_Read_Left(var Value: Variant; Args: TArguments);
procedure TListItem_Write_Left(const Value: Variant; Args: TArguments);
procedure TListItem_Read_ListView(var Value: Variant; Args: TArguments);
procedure TListItem_Read_Owner(var Value: Variant; Args: TArguments);
procedure TListItem_Read_OverlayIndex(var Value: Variant; Args: TArguments);
procedure TListItem_Write_OverlayIndex(const Value: Variant; Args: TArguments);
procedure TListItem_Read_Selected(var Value: Variant; Args: TArguments);
procedure TListItem_Write_Selected(const Value: Variant; Args: TArguments);
procedure TListItem_Read_StateIndex(var Value: Variant; Args: TArguments);
procedure TListItem_Write_StateIndex(const Value: Variant; Args: TArguments);
procedure TListItem_Read_SubItems(var Value: Variant; Args: TArguments);
procedure TListItem_Write_SubItems(const Value: Variant; Args: TArguments);
procedure TListItem_Read_Top(var Value: Variant; Args: TArguments);
procedure TListItem_Write_Top(const Value: Variant; Args: TArguments);

  { TListItems }
procedure TListItems_Create(var Value: Variant; Args: TArguments);
procedure TListItems_Add(var Value: Variant; Args: TArguments);
procedure TListItems_Assign(var Value: Variant; Args: TArguments);
procedure TListItems_BeginUpdate(var Value: Variant; Args: TArguments);
procedure TListItems_Clear(var Value: Variant; Args: TArguments);
procedure TListItems_Delete(var Value: Variant; Args: TArguments);
procedure TListItems_EndUpdate(var Value: Variant; Args: TArguments);
procedure TListItems_IndexOf(var Value: Variant; Args: TArguments);
procedure TListItems_Insert(var Value: Variant; Args: TArguments);
procedure TListItems_Read_Count(var Value: Variant; Args: TArguments);
procedure TListItems_Read_Handle(var Value: Variant; Args: TArguments);
procedure TListItems_Read_Item(var Value: Variant; Args: TArguments);
procedure TListItems_Write_Item(const Value: Variant; Args: TArguments);
procedure TListItems_Read_Owner(var Value: Variant; Args: TArguments);

  { TCustomListView }
procedure TCustomListView_AlphaSort(var Value: Variant; Args: TArguments);
procedure TCustomListView_Arrange(var Value: Variant; Args: TArguments);
procedure TCustomListView_FindCaption(var Value: Variant; Args: TArguments);
procedure TCustomListView_FindData(var Value: Variant; Args: TArguments);
procedure TCustomListView_GetItemAt(var Value: Variant; Args: TArguments);
procedure TCustomListView_GetNextItem(var Value: Variant; Args: TArguments);
procedure TCustomListView_GetSearchString(var Value: Variant; Args: TArguments);
procedure TCustomListView_IsEditing(var Value: Variant; Args: TArguments);
procedure TCustomListView_Scroll(var Value: Variant; Args: TArguments);
procedure TCustomListView_Read_Checkboxes(var Value: Variant; Args: TArguments);
procedure TCustomListView_Write_Checkboxes(const Value: Variant; Args: TArguments);
procedure TCustomListView_Read_Column(var Value: Variant; Args: TArguments);
procedure TCustomListView_Read_DropTarget(var Value: Variant; Args: TArguments);
procedure TCustomListView_Write_DropTarget(const Value: Variant; Args: TArguments);
procedure TCustomListView_Read_GridLines(var Value: Variant; Args: TArguments);
procedure TCustomListView_Write_GridLines(const Value: Variant; Args: TArguments);
procedure TCustomListView_Read_HotTrack(var Value: Variant; Args: TArguments);
procedure TCustomListView_Write_HotTrack(const Value: Variant; Args: TArguments);
procedure TCustomListView_Read_ItemFocused(var Value: Variant; Args: TArguments);
procedure TCustomListView_Write_ItemFocused(const Value: Variant; Args: TArguments);
procedure TCustomListView_Read_RowSelect(var Value: Variant; Args: TArguments);
procedure TCustomListView_Write_RowSelect(const Value: Variant; Args: TArguments);
procedure TCustomListView_Read_SelCount(var Value: Variant; Args: TArguments);
procedure TCustomListView_Read_Selected(var Value: Variant; Args: TArguments);
procedure TCustomListView_Write_Selected(const Value: Variant; Args: TArguments);
procedure TCustomListView_StringWidth(var Value: Variant; Args: TArguments);
procedure TCustomListView_UpdateItems(var Value: Variant; Args: TArguments);
procedure TCustomListView_Read_TopItem(var Value: Variant; Args: TArguments);
procedure TCustomListView_Read_VisibleRowCount(var Value: Variant; Args: TArguments);

  { TListView }
procedure TListView_Create(var Value: Variant; Args: TArguments);

  { TAnimate }
procedure TAnimate_Create(var Value: Variant; Args: TArguments);
procedure TAnimate_Read_FrameCount(var Value: Variant; Args: TArguments);
procedure TAnimate_Read_FrameHeight(var Value: Variant; Args: TArguments);
procedure TAnimate_Read_FrameWidth(var Value: Variant; Args: TArguments);
procedure TAnimate_Read_Open(var Value: Variant; Args: TArguments);
procedure TAnimate_Write_Open(const Value: Variant; Args: TArguments);
procedure TAnimate_Play(var Value: Variant; Args: TArguments);
procedure TAnimate_Reset(var Value: Variant; Args: TArguments);
procedure TAnimate_Seek(var Value: Variant; Args: TArguments);
procedure TAnimate_Stop(var Value: Variant; Args: TArguments);
procedure TAnimate_Read_ResHandle(var Value: Variant; Args: TArguments);
procedure TAnimate_Write_ResHandle(const Value: Variant; Args: TArguments);
procedure TAnimate_Read_ResId(var Value: Variant; Args: TArguments);
procedure TAnimate_Write_ResId(const Value: Variant; Args: TArguments);
procedure TAnimate_Read_ResName(var Value: Variant; Args: TArguments);
procedure TAnimate_Write_ResName(const Value: Variant; Args: TArguments);
