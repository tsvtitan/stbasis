...
uses UMainUnited, tsvInterpreterCore;
  ...
  { TShape }
procedure TShape_Create(var Value: Variant; Args: TArguments);
procedure TShape_StyleChanged(var Value: Variant; Args: TArguments);
procedure TShape_Read_Brush(var Value: Variant; Args: TArguments);
procedure TShape_Write_Brush(const Value: Variant; Args: TArguments);
procedure TShape_Read_Pen(var Value: Variant; Args: TArguments);
procedure TShape_Write_Pen(const Value: Variant; Args: TArguments);
procedure TShape_Read_Shape(var Value: Variant; Args: TArguments);
procedure TShape_Write_Shape(const Value: Variant; Args: TArguments);

  { TPaintBox }
procedure TPaintBox_Create(var Value: Variant; Args: TArguments);

  { TImage }
procedure TImage_Create(var Value: Variant; Args: TArguments);
procedure TImage_Read_Canvas(var Value: Variant; Args: TArguments);
procedure TImage_Read_AutoSize(var Value: Variant; Args: TArguments);
procedure TImage_Write_AutoSize(const Value: Variant; Args: TArguments);
procedure TImage_Read_Center(var Value: Variant; Args: TArguments);
procedure TImage_Write_Center(const Value: Variant; Args: TArguments);
procedure TImage_Read_IncrementalDisplay(var Value: Variant; Args: TArguments);
procedure TImage_Write_IncrementalDisplay(const Value: Variant; Args: TArguments);
procedure TImage_Read_Picture(var Value: Variant; Args: TArguments);
procedure TImage_Write_Picture(const Value: Variant; Args: TArguments);
procedure TImage_Read_Stretch(var Value: Variant; Args: TArguments);
procedure TImage_Write_Stretch(const Value: Variant; Args: TArguments);
procedure TImage_Read_Transparent(var Value: Variant; Args: TArguments);
procedure TImage_Write_Transparent(const Value: Variant; Args: TArguments);

  { TBevel }
procedure TBevel_Create(var Value: Variant; Args: TArguments);
procedure TBevel_Read_Shape(var Value: Variant; Args: TArguments);
procedure TBevel_Write_Shape(const Value: Variant; Args: TArguments);
procedure TBevel_Read_Style(var Value: Variant; Args: TArguments);
procedure TBevel_Write_Style(const Value: Variant; Args: TArguments);

  { TTimer }
procedure TTimer_Create(var Value: Variant; Args: TArguments);
procedure TTimer_Read_Enabled(var Value: Variant; Args: TArguments);
procedure TTimer_Write_Enabled(const Value: Variant; Args: TArguments);
procedure TTimer_Read_Interval(var Value: Variant; Args: TArguments);
procedure TTimer_Write_Interval(const Value: Variant; Args: TArguments);

  { TPanel }
procedure TPanel_Create(var Value: Variant; Args: TArguments);

  { TPage }
procedure TPage_Create(var Value: Variant; Args: TArguments);

  { TNotebook }
procedure TNotebook_Create(var Value: Variant; Args: TArguments);
procedure TNotebook_Read_ActivePage(var Value: Variant; Args: TArguments);
procedure TNotebook_Write_ActivePage(const Value: Variant; Args: TArguments);
procedure TNotebook_Read_PageIndex(var Value: Variant; Args: TArguments);
procedure TNotebook_Write_PageIndex(const Value: Variant; Args: TArguments);
procedure TNotebook_Read_Pages(var Value: Variant; Args: TArguments);
procedure TNotebook_Write_Pages(const Value: Variant; Args: TArguments);

  { THeader }
procedure THeader_Create(var Value: Variant; Args: TArguments);
procedure THeader_Read_SectionWidth(var Value: Variant; Args: TArguments);
procedure THeader_Write_SectionWidth(const Value: Variant; Args: TArguments);
procedure THeader_Read_AllowResize(var Value: Variant; Args: TArguments);
procedure THeader_Write_AllowResize(const Value: Variant; Args: TArguments);
procedure THeader_Read_BorderStyle(var Value: Variant; Args: TArguments);
procedure THeader_Write_BorderStyle(const Value: Variant; Args: TArguments);
procedure THeader_Read_Sections(var Value: Variant; Args: TArguments);
procedure THeader_Write_Sections(const Value: Variant; Args: TArguments);

  { TRadioGroup }
procedure TRadioGroup_Create(var Value: Variant; Args: TArguments);

  { TSplitter }
procedure TSplitter_Create(var Value: Variant; Args: TArguments);
procedure TSplitter_Read_Beveled(var Value: Variant; Args: TArguments);
procedure TSplitter_Write_Beveled(const Value: Variant; Args: TArguments);
procedure TSplitter_Read_MinSize(var Value: Variant; Args: TArguments);
procedure TSplitter_Write_MinSize(const Value: Variant; Args: TArguments);
