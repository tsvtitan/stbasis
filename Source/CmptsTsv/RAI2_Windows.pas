...
procedure RAI2_Sleep(var Value: Variant; Args: TArgs);
begin
...
begin
  ...
  begin
   ...
   { TPoint }
    ...
    AddFun('Windows', 'Point', RAI2_Point, 2, [varInteger, varInteger], varRecord);
   { TRect }
    ...
    AddFun('Windows', 'Rect', RAI2_Rect, 4, [varInteger, varInteger, varInteger, varInteger], varRecord);
    AddFun('Windows', 'Bounds', RAI2_Bounds, 4, [varInteger, varInteger, varInteger, varInteger], varRecord);
    AddFun('Windows', 'Sleep', RAI2_Sleep, 1,[varInteger], varUnknown);
