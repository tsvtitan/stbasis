...
uses SysUtils, UMainUnited, tsvInterpreterCore;
  ...
  { TMenuItem }
procedure TMenuItem_Delete(var Value: Variant; Args: TArguments);
procedure TMenuItem_Click(var Value: Variant; Args: TArguments);
procedure TMenuItem_IndexOf(var Value: Variant; Args: TArguments);
procedure TMenuItem_Add(var Value: Variant; Args: TArguments);
procedure TMenuItem_Remove(var Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Command(var Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Handle(var Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Count(var Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Items(var Value: Variant; Args: TArguments);
procedure TMenuItem_Read_MenuIndex(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_MenuIndex(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Parent(var Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Break(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_Break(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Caption(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_Caption(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Checked(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_Checked(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Default(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_Default(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Enabled(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_Enabled(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_GroupIndex(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_GroupIndex(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_HelpContext(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_HelpContext(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Hint(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_Hint(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_RadioItem(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_RadioItem(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_ShortCut(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_ShortCut(const Value: Variant; Args: TArguments);
procedure TMenuItem_Read_Visible(var Value: Variant; Args: TArguments);
procedure TMenuItem_Write_Visible(const Value: Variant; Args: TArguments);

  { TMenu }
procedure TMenu_DispatchCommand(var Value: Variant; Args: TArguments);
procedure TMenu_DispatchPopup(var Value: Variant; Args: TArguments);
procedure TMenu_FindItem(var Value: Variant; Args: TArguments);
procedure TMenu_GetHelpContext(var Value: Variant; Args: TArguments);
procedure TMenu_Read_Handle(var Value: Variant; Args: TArguments);
procedure TMenu_Read_WindowHandle(var Value: Variant; Args: TArguments);
procedure TMenu_Write_WindowHandle(const Value: Variant; Args: TArguments);
procedure TMenu_Read_Items(var Value: Variant; Args: TArguments);

  { TMainMenu }
procedure TMainMenu_Create(var Value: Variant; Args: TArguments);
procedure TMainMenu_Merge(var Value: Variant; Args: TArguments);
procedure TMainMenu_Unmerge(var Value: Variant; Args: TArguments);
procedure TMainMenu_Read_AutoMerge(var Value: Variant; Args: TArguments);
procedure TMainMenu_Write_AutoMerge(const Value: Variant; Args: TArguments);

  { TPopupMenu }
procedure TPopupMenu_Create(var Value: Variant; Args: TArguments);
procedure TPopupMenu_Popup(var Value: Variant; Args: TArguments);
procedure TPopupMenu_Read_PopupComponent(var Value: Variant; Args: TArguments);
procedure TPopupMenu_Write_PopupComponent(const Value: Variant; Args: TArguments);
procedure TPopupMenu_Read_Alignment(var Value: Variant; Args: TArguments);
procedure TPopupMenu_Write_Alignment(const Value: Variant; Args: TArguments);
procedure TPopupMenu_Read_AutoPopup(var Value: Variant; Args: TArguments);
procedure TPopupMenu_Write_AutoPopup(const Value: Variant; Args: TArguments);
procedure TPopupMenu_Read_HelpContext(var Value: Variant; Args: TArguments);
procedure TPopupMenu_Write_HelpContext(const Value: Variant; Args: TArguments);

procedure Menus_ShortCut(var Value: Variant; Args: TArguments);
procedure Menus_ShortCutToKey(var Value: Variant; Args: TArguments);
procedure Menus_ShortCutToText(var Value: Variant; Args: TArguments);
procedure Menus_TextToShortCut(var Value: Variant; Args: TArguments);
procedure Menus_NewItem(var Value: Variant; Args: TArguments);
procedure Menus_NewLine(var Value: Variant; Args: TArguments);
...
procedure TMenuItem_Create(var Value: Variant; Args: TArguments);
begin
  Value := O2V(TMenuItem.Create(V2O(Args.Values[0]) as TComponent));
end;

{  procedure Insert(Index: Integer; Item: TMenuItem); }
procedure TMenuItem_Insert(var Value: Variant; Args: TArguments);
begin
...
procedure TMenu_IsShortCut(var Value: Variant; Args: TArguments);
begin
...
(*
procedure RegisterMenusAdapter(MenusAdapter: TMenusAdapter);
begin
  with MenusAdapter do
  begin
   { EMenuError }
   ...
   { TPopupMenu }
    ...
    AddFun('Menus', 'ShortCut', Menus_ShortCut, 2, [varEmpty, varEmpty], varEmpty);
    AddFun('Menus', 'ShortCutToKey', Menus_ShortCutToKey, 3, [varEmpty, varByRef, varByRef], varEmpty);
    AddFun('Menus', 'ShortCutToText', Menus_ShortCutToText, 1, [varEmpty], varEmpty);
    AddFun('Menus', 'TextToShortCut', Menus_TextToShortCut, 1, [varEmpty], varEmpty);
   { AddFun('Menus', 'NewMenu', Menus_NewMenu, 3, [varEmpty, varEmpty, varEmpty], nil);
    AddFun('Menus', 'NewPopupMenu', Menus_NewPopupMenu, 5, [varEmpty, varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
    AddFun('Menus', 'NewSubMenu', Menus_NewSubMenu, 4, [varEmpty, varEmpty, varEmpty, varEmpty], varEmpty); }
    AddFun('Menus', 'NewItem', Menus_NewItem, 7, [varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
    AddFun('Menus', 'NewLine', Menus_NewLine, 0, [0], varEmpty);
  end;    { with }
  RegisterClasses([TMainMenu, TPopupMenu, TMenuItem]);
end;    { RegisterMenusAdapter }
*)
