...
uses UComponents, extctrls, buttons, toolwin, Menus, ActnList,
     ...
     tsvInterpreterIndy, tsvInterpreterAbbrevia;
...
//  CreateDesignComponentEditorLocal(TChart, TChartEditor);
...
//  CreateDesignPropertyEditorLocal(TypeInfo(TChartSeriesList), TChart, 'SeriesList', TChartSeriesListProperty);
...
begin
  CreateDesignPropertyTranslateLocal('Action','Действие');
  CreateDesignPropertyTranslateLocal('Align','Привязка');
  CreateDesignPropertyTranslateLocal('Anchors','Якори');
  CreateDesignPropertyTranslateLocal('AutoSize','Авторазмер');
  CreateDesignPropertyTranslateLocal('Caption','Заголовок');
  CreateDesignPropertyTranslateLocal('ClientHeight','Клиентская высота');
  CreateDesignPropertyTranslateLocal('ClientWidth','Клиентская ширина');
  CreateDesignPropertyTranslateLocal('Color','Цвет');
  CreateDesignPropertyTranslateLocal('Constraints','Ограничения');
  CreateDesignPropertyTranslateLocal('Cursor','Курсор');
  CreateDesignPropertyTranslateLocal('DragCursor','Курсор при перетаскивании');
  CreateDesignPropertyTranslateLocal('DragKind','Выбор перетаскивания');
  CreateDesignPropertyTranslateLocal('DragMode','Режим перетаскивания');
  CreateDesignPropertyTranslateLocal('Enabled','Включен');
  CreateDesignPropertyTranslateLocal('Font','Шрифт');
  CreateDesignPropertyTranslateLocal('Height','Высота');
  CreateDesignPropertyTranslateLocal('Hint','Подсказка');
  CreateDesignPropertyTranslateLocal('Left','Слева');
  CreateDesignPropertyTranslateLocal('Name','Имя');
  CreateDesignPropertyTranslateLocal('ParentColor','Наследовать цвет');
  CreateDesignPropertyTranslateLocal('ParentShowHint','Наследовать видимость подсказки');
  CreateDesignPropertyTranslateLocal('PopupMenu','Всплывающее меню');
  CreateDesignPropertyTranslateLocal('ShowHint','Показывать подсказку');
  CreateDesignPropertyTranslateLocal('Text','Текст');
  CreateDesignPropertyTranslateLocal('Top','Сверху');
  CreateDesignPropertyTranslateLocal('Visible','Видимость');
  CreateDesignPropertyTranslateLocal('Width','Ширина');
  CreateDesignPropertyTranslateLocal('BevelEdges','Краи обрамления');
  CreateDesignPropertyTranslateLocal('BevelInner','Внутреннее обрамление');
  CreateDesignPropertyTranslateLocal('BevelKind','Выбор обрамления');
  CreateDesignPropertyTranslateLocal('BevelWidth','Ширина обрамления');
  CreateDesignPropertyTranslateLocal('BorderWidth','Ширина бордюра');
  CreateDesignPropertyTranslateLocal('Brush','Кисть');
  CreateDesignPropertyTranslateLocal('Pen','Ручка');
  CreateDesignPropertyTranslateLocal('Ctl3D','3D обрамление');
  CreateDesignPropertyTranslateLocal('DockSite','Место привязки');
  CreateDesignPropertyTranslateLocal('ParentCtl3D','Наследовать 3D обрамление');
  CreateDesignPropertyTranslateLocal('TabOrder','Порядок перехода');
  CreateDesignPropertyTranslateLocal('TabStop','Остановка при переходе');
  CreateDesignPropertyTranslateLocal('UseDockManager','Использовать менеджер привязки');
  CreateDesignPropertyTranslateLocal('Alignment','Варавнивание');
  CreateDesignPropertyTranslateLocal('FullRepaint','Полная перерисовка');
  CreateDesignPropertyTranslateLocal('FocusControl','Фокусируемый объект');
  CreateDesignPropertyTranslateLocal('Layout','Формат');
  CreateDesignPropertyTranslateLocal('ShowAccelChar','Показывать подчеркивание при &');
  CreateDesignPropertyTranslateLocal('WordWrap','Перевод слов на другую строку');
  CreateDesignPropertyTranslateLocal('AutoSelect','Автовыбор');
  CreateDesignPropertyTranslateLocal('BorderStyle','Стиль бордюра');
  CreateDesignPropertyTranslateLocal('CharCase','Регистр');
  CreateDesignPropertyTranslateLocal('HideSelection','Скрытвать выделение');
  CreateDesignPropertyTranslateLocal('MaxLength','Макс.длина');
  CreateDesignPropertyTranslateLocal('PasswordChar','Буква пароля');
  CreateDesignPropertyTranslateLocal('ReadOnly','Только чтение');
  CreateDesignPropertyTranslateLocal('AutoMerge','Автослияние');
  CreateDesignPropertyTranslateLocal('Images','Список картинок');
  CreateDesignPropertyTranslateLocal('Items','Элементы');
  CreateDesignPropertyTranslateLocal('AutoPopup','Автовсплытие');
  CreateDesignPropertyTranslateLocal('MenuAnimation','Анимация меню');
  CreateDesignPropertyTranslateLocal('Lines','Линии');
  CreateDesignPropertyTranslateLocal('ScrollBars','Панели прокручивания');
  CreateDesignPropertyTranslateLocal('WantReturns','Возврат каретки');
  CreateDesignPropertyTranslateLocal('WantTabs','Табуляция');
  CreateDesignPropertyTranslateLocal('Cancel','Отмена');
  CreateDesignPropertyTranslateLocal('Default','По умолчанию');
  CreateDesignPropertyTranslateLocal('ModalResult','Результат модальности');
  CreateDesignPropertyTranslateLocal('Checked','Выбрано');
  CreateDesignPropertyTranslateLocal('State','Статус');
  CreateDesignPropertyTranslateLocal('Columns','Колонки');
  CreateDesignPropertyTranslateLocal('ExtendedSelect','Расширенное выделение');
  CreateDesignPropertyTranslateLocal('IntegralHeight','Интегральная высота');
  CreateDesignPropertyTranslateLocal('ItemHeight','Высота элемента');
  CreateDesignPropertyTranslateLocal('ItemIndex','Индекс элемента');
  CreateDesignPropertyTranslateLocal('MultiSelect','Мультивыделение');
  CreateDesignPropertyTranslateLocal('Sorted','Сортировка');
  CreateDesignPropertyTranslateLocal('TabWidth','Ширина закладки');
  CreateDesignPropertyTranslateLocal('TopIndex','Верхний индекс');
  CreateDesignPropertyTranslateLocal('fsBold','Жирный');
  CreateDesignPropertyTranslateLocal('fsItalic','Курсив');
  CreateDesignPropertyTranslateLocal('fsUnderline','Подчеркнутый');
  CreateDesignPropertyTranslateLocal('fsStrikeOut','Перечеркнутый');
  CreateDesignPropertyTranslateLocal('DropDownCount','Количество выпадающих элементов');
  CreateDesignPropertyTranslateLocal('Kind','Выбор');
  CreateDesignPropertyTranslateLocal('Max','Максимум.');
  CreateDesignPropertyTranslateLocal('Min','Минимум.');
  CreateDesignPropertyTranslateLocal('PageSize','Размер страницы');
  CreateDesignPropertyTranslateLocal('Position','Позиция');
  CreateDesignPropertyTranslateLocal('Actions','Действия');
  CreateDesignPropertyTranslateLocal('MaxHeight','Макс.высота');
  CreateDesignPropertyTranslateLocal('MaxWidth','Макс.ширина');
  CreateDesignPropertyTranslateLocal('MinHeight','Мин.высота');
  CreateDesignPropertyTranslateLocal('MinWidth','Мин.ширина');
  CreateDesignPropertyTranslateLocal('ActiveControl','Активный объект');
  CreateDesignPropertyTranslateLocal('AutoScroll','Автопрокрутка');
  CreateDesignPropertyTranslateLocal('BorderIcons','Кнопки бордюра');
  CreateDesignPropertyTranslateLocal('biSystemMenu','Системные кнопки');
  CreateDesignPropertyTranslateLocal('biMinimize','Кнопка свернуть');
  CreateDesignPropertyTranslateLocal('biMaximize','Кнопка развернуть');
  CreateDesignPropertyTranslateLocal('biHelp','Кнопка помощи');
  CreateDesignPropertyTranslateLocal('DefaultMonitor','Монитор по умолчанию');
  CreateDesignPropertyTranslateLocal('FormStyle','Стиль формы');
  CreateDesignPropertyTranslateLocal('HorzScrollBar','Горизонтальный скролл');
  CreateDesignPropertyTranslateLocal('VertScrollBar','Вертикальный скролл');
  CreateDesignPropertyTranslateLocal('ButtonSize','Размер кнопки');
  CreateDesignPropertyTranslateLocal('Increment','Приращение');
  CreateDesignPropertyTranslateLocal('Margin','Отступ');
  CreateDesignPropertyTranslateLocal('Range','Область');
  CreateDesignPropertyTranslateLocal('Size','Размер');
  CreateDesignPropertyTranslateLocal('Smooth','Плавность');
  CreateDesignPropertyTranslateLocal('Style','Стиль');
  CreateDesignPropertyTranslateLocal('Tracking','Трассировка');
  CreateDesignPropertyTranslateLocal('Icon','Иконка');
  CreateDesignPropertyTranslateLocal('Bitmap','Битовое изображение');
  CreateDesignPropertyTranslateLocal('KeyPreview','Отслеживать нажатие клавиш');
  CreateDesignPropertyTranslateLocal('Menu','Меню');
  CreateDesignPropertyTranslateLocal('ParentFont','Наследовать шрифт');
  CreateDesignPropertyTranslateLocal('PixelsPerInch','Количество Пикселов на дюйм');
  CreateDesignPropertyTranslateLocal('PrintScale','Масштаб при печати');
  CreateDesignPropertyTranslateLocal('Scaled','Масштабирование');
  CreateDesignPropertyTranslateLocal('Tag','Этикетка');
  CreateDesignPropertyTranslateLocal('WindowMenu','Меню окна');
  CreateDesignPropertyTranslateLocal('WindowState','Статус окна');
  CreateDesignPropertyTranslateLocal('Charset','Кодировка');
  CreateDesignPropertyTranslateLocal('Pitch','Шаг');
  CreateDesignPropertyTranslateLocal('akLeft','Слева');
  CreateDesignPropertyTranslateLocal('akTop','Сверху');
  CreateDesignPropertyTranslateLocal('akRight','Справа');
  CreateDesignPropertyTranslateLocal('akBottom','Снизу');
  CreateDesignPropertyTranslateLocal('GroupIndex','Индекс группировки');
  CreateDesignPropertyTranslateLocal('Transparent','Прозрачность');
  CreateDesignPropertyTranslateLocal('AllowAllUp','Всегда вверх');
  CreateDesignPropertyTranslateLocal('Flat','Флет');
  CreateDesignPropertyTranslateLocal('Down','Вдавлено');
  CreateDesignPropertyTranslateLocal('beLeft','Слева');
  CreateDesignPropertyTranslateLocal('beTop','Сверху');
  CreateDesignPropertyTranslateLocal('beRight','Справа');
  CreateDesignPropertyTranslateLocal('beBottom','Снизу');
  CreateDesignPropertyTranslateLocal('EditMask','Маска редактирования');
  CreateDesignPropertyTranslateLocal('BevelOuter','Внешнее обрамление');
  CreateDesignPropertyTranslateLocal('DefaultColorColor','Цвет по умолчанию');
  CreateDesignPropertyTranslateLocal('NoneColorColor','Цвет которого нет');
  CreateDesignPropertyTranslateLocal('Selected','Выделенный');
  CreateDesignPropertyTranslateLocal('Glyph','Битовое изображение');
  CreateDesignPropertyTranslateLocal('NumGlyphs','Количество изображение');
  CreateDesignPropertyTranslateLocal('Spacing','Расстояние');
  CreateDesignPropertyTranslateLocal('cbStandardColors','Стандартные цвета');
  CreateDesignPropertyTranslateLocal('cbExtendedColors','Расширенные цвета');
  CreateDesignPropertyTranslateLocal('cbSystemColors','Системные цвета');
  CreateDesignPropertyTranslateLocal('cbIncludeNone','Включая нет цвета');
  CreateDesignPropertyTranslateLocal('cbIncludeDefault','Включая цвета по умолчанию');
  CreateDesignPropertyTranslateLocal('cbCustomColor','Выборочные цвета');
  CreateDesignPropertyTranslateLocal('cbPrettyNames','Расширенные имена');

  CreateDesignPropertyTranslateLocal('ColCount','Количество колонок');
  CreateDesignPropertyTranslateLocal('DefaultColWidth','Ширина колонки по умолчанию');
  CreateDesignPropertyTranslateLocal('DefaultDrawing','Перерисовка по умолчанию');
  CreateDesignPropertyTranslateLocal('DefaultRowHeight','Высота строки по умолчанию');
  CreateDesignPropertyTranslateLocal('FixedColor','Фиксированный цвет');
  CreateDesignPropertyTranslateLocal('FixedCols','Количество фикс. колонок');
  CreateDesignPropertyTranslateLocal('FixedRows','Количество фикс. строк');
  CreateDesignPropertyTranslateLocal('GridLineWidth','Ширина линии сетки');
  CreateDesignPropertyTranslateLocal('RowCount','Количество строк');
  CreateDesignPropertyTranslateLocal('Options','Настройка');
  CreateDesignPropertyTranslateLocal('goFixedVertLine','Фикс.вертикальная линия');
  CreateDesignPropertyTranslateLocal('goFixedHorzLine','Фикс.горизонтальная линия');
  CreateDesignPropertyTranslateLocal('goVertLine','Вертикальная линия');
  CreateDesignPropertyTranslateLocal('goHorzLine','Горизонтальная линия');
  CreateDesignPropertyTranslateLocal('goRangeSelect','Многострочное выделение');
  CreateDesignPropertyTranslateLocal('goDrawFocusSelect','Рисовать фокус выделением');
  CreateDesignPropertyTranslateLocal('goRowSizing','Изменять размер строки');
  CreateDesignPropertyTranslateLocal('goColSizing','Изменять размер колонки');
  CreateDesignPropertyTranslateLocal('goRowMoving','Передвигать строки');
  CreateDesignPropertyTranslateLocal('goColMoving','Передвигать колонки');
  CreateDesignPropertyTranslateLocal('goEditing','Редактирование');
  CreateDesignPropertyTranslateLocal('goTabs','Табуляция');
  CreateDesignPropertyTranslateLocal('goRowSelect','Выделять строку');
  CreateDesignPropertyTranslateLocal('goAlwaysShowEditor','Всегда показывать редактор');
  CreateDesignPropertyTranslateLocal('goThumbTracking','Трассировка');
  CreateDesignPropertyTranslateLocal('Center','Центровка');
  CreateDesignPropertyTranslateLocal('IncrementalDisplay','Икрементируемый Дисплей');
  CreateDesignPropertyTranslateLocal('Picture','Изображение');
  CreateDesignPropertyTranslateLocal('Stretch','Растягивать');
  CreateDesignPropertyTranslateLocal('Shape','Фигура');
  CreateDesignPropertyTranslateLocal('Mode','Режим');
  CreateDesignPropertyTranslateLocal('AutoSnap','Автошаг');
  CreateDesignPropertyTranslateLocal('Beveled','Обрамленный');
  CreateDesignPropertyTranslateLocal('MinSize','Минимальный размер');
  CreateDesignPropertyTranslateLocal('ResizeStyle','Стиль растягивания');
  CreateDesignPropertyTranslateLocal('AutoDock','Автопривязка');
  CreateDesignPropertyTranslateLocal('AutoDrag','Автоперетаскивание');
  CreateDesignPropertyTranslateLocal('RowSize','Размер строки');
  CreateDesignPropertyTranslateLocal('RowSnap','Шаг строки');
  CreateDesignPropertyTranslateLocal('HotTrack','Подсветка');
  CreateDesignPropertyTranslateLocal('MultiLine','Мультилиния');
  CreateDesignPropertyTranslateLocal('RaggedRight','Неровность справа');

  CreateDesignPropertyTranslateLocal('TabHeight','Высота закладки');
  CreateDesignPropertyTranslateLocal('TabIndex','Индекс закладки');
  CreateDesignPropertyTranslateLocal('TabPosition','Позиция закладки');
  CreateDesignPropertyTranslateLocal('Tabs','Закладки');
  CreateDesignPropertyTranslateLocal('ActivePage','Астивная страница');
  CreateDesignPropertyTranslateLocal('HideScrollBars','Скрыть скроллы');
  CreateDesignPropertyTranslateLocal('PlainText','Ровный текст');
  CreateDesignPropertyTranslateLocal('Frequency','Частота');
  CreateDesignPropertyTranslateLocal('LineSize','Размер линии');
  CreateDesignPropertyTranslateLocal('Orientation','Ориентация');
  CreateDesignPropertyTranslateLocal('SelEnd','Конец выделения');
  CreateDesignPropertyTranslateLocal('SelStart','Начало выделения');
  CreateDesignPropertyTranslateLocal('SliderVisible','Показывать движки');
  CreateDesignPropertyTranslateLocal('TickMarks','Маркировать метки');
  CreateDesignPropertyTranslateLocal('TickStyle','Стиль метки');
  CreateDesignPropertyTranslateLocal('AlignButton','Привязка кнопки');
  CreateDesignPropertyTranslateLocal('ArrowKeys','Стреловидные клавиши');
  CreateDesignPropertyTranslateLocal('Associate','Ассоциация');
  CreateDesignPropertyTranslateLocal('Wrap','Перевод');
  CreateDesignPropertyTranslateLocal('Thousands','Тысячи');
  CreateDesignPropertyTranslateLocal('HotKey','Горячая клавиша');
  CreateDesignPropertyTranslateLocal('Modifiers','Модификаторы');
  ...
  CreateDesignPropertyTranslateLocal('InvalidKeys','Исключаемые клавиши');
  CreateDesignPropertyTranslateLocal('hcNone','Нет');
  ...
  CreateDesignPropertyTranslateLocal('Active','Активный');
  CreateDesignPropertyTranslateLocal('CommonAVI','Системные AVI');
  CreateDesignPropertyTranslateLocal('FileName','Имя файла');
  CreateDesignPropertyTranslateLocal('Repetitions','Повторения');
  CreateDesignPropertyTranslateLocal('StartFrame','Первый кадр');
  CreateDesignPropertyTranslateLocal('StopFrame','Стоп кадр ');
  CreateDesignPropertyTranslateLocal('Timers','Таймеры');
  CreateDesignPropertyTranslateLocal('Date','Дата');
  CreateDesignPropertyTranslateLocal('DateFormat','Формат даты');
  CreateDesignPropertyTranslateLocal('DateMode','Режим даты');
  CreateDesignPropertyTranslateLocal('MaxDate','Максимальная дата');
  CreateDesignPropertyTranslateLocal('MinDate','Минимальная дата');
  CreateDesignPropertyTranslateLocal('ParseInput','Разбирать ввод');
  CreateDesignPropertyTranslateLocal('ShowCheckBox','Показывать флажок');
  CreateDesignPropertyTranslateLocal('Time','Время');
  CreateDesignPropertyTranslateLocal('FirstDayOfWeek','Первый день недели');
  CreateDesignPropertyTranslateLocal('MaxSelectRange','Максимально выделяемое расстояние');
  CreateDesignPropertyTranslateLocal('ShowToday','Показывать сегодня');
  CreateDesignPropertyTranslateLocal('ShowTodayCircle','Показывать сегодня в цикле');
  CreateDesignPropertyTranslateLocal('WeekNumbers','Номера недели');
  CreateDesignPropertyTranslateLocal('AutoExpand','Автораскрытие');
  CreateDesignPropertyTranslateLocal('ChangeDelay','Задержка изменения');
  CreateDesignPropertyTranslateLocal('Indent','Отступ');
  CreateDesignPropertyTranslateLocal('RightClickSelect','Выделять правой кнопкой мыши');
  CreateDesignPropertyTranslateLocal('RowSelect','Выделять строку');
  CreateDesignPropertyTranslateLocal('ShowButtons','Показывать кнопки');
  CreateDesignPropertyTranslateLocal('ShowLines','Показывать линии');
  CreateDesignPropertyTranslateLocal('ShowRoot','Показывать корень');
  CreateDesignPropertyTranslateLocal('SortType','Тип сортировки');
  CreateDesignPropertyTranslateLocal('StateImages','Статусный список картинок');
  CreateDesignPropertyTranslateLocal('Checkboxes','Флажки');
  CreateDesignPropertyTranslateLocal('ColumnClick','Нажатие по колонке');
  CreateDesignPropertyTranslateLocal('FullDrag','Полное перетаскивание');
  CreateDesignPropertyTranslateLocal('GridLines','Линии сетки');
  CreateDesignPropertyTranslateLocal('HotTrackStyles','Стили подсветки');
  CreateDesignPropertyTranslateLocal('htHandPoint','Кисть');
  CreateDesignPropertyTranslateLocal('htUnderlineCold','Перечеркивание');
  CreateDesignPropertyTranslateLocal('htUnderlineHot','Подчеркивание');
  CreateDesignPropertyTranslateLocal('HoverTime','Время срабатывания подсветки');
  CreateDesignPropertyTranslateLocal('IconOptions','Настройка икон');
  CreateDesignPropertyTranslateLocal('Arrangement','Размещение');
  CreateDesignPropertyTranslateLocal('AutoArrange','Авторазмещение');
  CreateDesignPropertyTranslateLocal('WrapText','Перевод каретки в тексте');
  CreateDesignPropertyTranslateLocal('LargeImages','Список картинок для больших иконок');
  CreateDesignPropertyTranslateLocal('ShowColumnHeaders','Показывать заголовки колонок');
  CreateDesignPropertyTranslateLocal('ShowWorkAreas','Показывать рабочую область');
  CreateDesignPropertyTranslateLocal('SmallImages','Список картинок для маленьких иконок');
  CreateDesignPropertyTranslateLocal('ViewStyle','Стиль показа');
  CreateDesignPropertyTranslateLocal('AutoHint','Автоподсказка');
  CreateDesignPropertyTranslateLocal('Panels','Панели');
  CreateDesignPropertyTranslateLocal('SimplePanel','Простая панель');
  CreateDesignPropertyTranslateLocal('SimpleText','Простой текст');
  CreateDesignPropertyTranslateLocal('SizeGrid','Размер сетки');
  CreateDesignPropertyTranslateLocal('UseSystemFont','Использовать системный шрифт');
  CreateDesignPropertyTranslateLocal('ButtonHeight','Высота кнопи');
  CreateDesignPropertyTranslateLocal('ButtonWidth','Ширина кнопки');
  CreateDesignPropertyTranslateLocal('DisabledImages','Список отключенных картинок');
  CreateDesignPropertyTranslateLocal('EdgeBorders','Краи бордюра');
  CreateDesignPropertyTranslateLocal('ebLeft','Левый');
  CreateDesignPropertyTranslateLocal('ebTop','Верхний');
  CreateDesignPropertyTranslateLocal('ebRight','Правый');
  CreateDesignPropertyTranslateLocal('ebBottom','Нижний');
  CreateDesignPropertyTranslateLocal('EdgeInner','Внутренний край');
  CreateDesignPropertyTranslateLocal('EdgeOuter','Внешний край');
  CreateDesignPropertyTranslateLocal('HotImages','Список горячих картинок');
  CreateDesignPropertyTranslateLocal('List','Список');
  CreateDesignPropertyTranslateLocal('ShowCaptions','Показывать заголовки');
  CreateDesignPropertyTranslateLocal('Wrapable','Перевернутый');
  CreateDesignPropertyTranslateLocal('BandBorderStyle','Стиль бордюра полосы');
  CreateDesignPropertyTranslateLocal('BandMaximize','Максимальная полоса');
  CreateDesignPropertyTranslateLocal('Bands','Полосы');
  CreateDesignPropertyTranslateLocal('FixedOrder','Фиксированный порядок');
  CreateDesignPropertyTranslateLocal('FixedSize','Фиксированный размер');
  CreateDesignPropertyTranslateLocal('ShowText','Показывать текст');
  CreateDesignPropertyTranslateLocal('Vertical','Вертикально');
  CreateDesignPropertyTranslateLocal('Control','Объект');
  CreateDesignPropertyTranslateLocal('AutoEnable','Автовключение');
  CreateDesignPropertyTranslateLocal('AutoOpen','Автооткрытие');
  CreateDesignPropertyTranslateLocal('AutoRewind','Автоперемотка');
  CreateDesignPropertyTranslateLocal('ColoredButtons','Цветные кнопки');
  CreateDesignPropertyTranslateLocal('btPlay','Воспроизведение');
  CreateDesignPropertyTranslateLocal('btPause','Пауза');
  CreateDesignPropertyTranslateLocal('btStop','Стоп');
  CreateDesignPropertyTranslateLocal('btNext','Вперед');
  CreateDesignPropertyTranslateLocal('btPrev','Предыдущий');
  CreateDesignPropertyTranslateLocal('btStep','Шаг');
  CreateDesignPropertyTranslateLocal('btBack','Назад');
  CreateDesignPropertyTranslateLocal('btRecord','Запись');
  CreateDesignPropertyTranslateLocal('btEject','Извлечь');
  CreateDesignPropertyTranslateLocal('DeviceType','Тип устройства');
  CreateDesignPropertyTranslateLocal('Display','Дисплей');
  CreateDesignPropertyTranslateLocal('EnabledButtons','Включенные кнопки');
  CreateDesignPropertyTranslateLocal('Shareable','Общий');
  CreateDesignPropertyTranslateLocal('VisibleButtons','Видимые кнопки');
  CreateDesignPropertyTranslateLocal('AllowActiveDoc','Всегда активизировать документ');
  CreateDesignPropertyTranslateLocal('AllowInPlace','Всегда внутри');
  CreateDesignPropertyTranslateLocal('AutoActivate','Автоактивизирование');
  CreateDesignPropertyTranslateLocal('CopyOnSave','Копировать при сохранении');
  CreateDesignPropertyTranslateLocal('Iconic','Свернутое');
  CreateDesignPropertyTranslateLocal('OldStreamFormat','Старый потоковый формат');
  CreateDesignPropertyTranslateLocal('SizeMode','Режим изменения размеров');
  CreateDesignPropertyTranslateLocal('DataSet','Набор данных');
  CreateDesignPropertyTranslateLocal('DataSource','Источник данных');
  CreateDesignPropertyTranslateLocal('EndDate','Конечная дата');
  CreateDesignPropertyTranslateLocal('TitleFont','Шрифт названия');
  CreateDesignPropertyTranslateLocal('dgEditing','Редактирование');
  CreateDesignPropertyTranslateLocal('dgAlwaysShowEditor','Всегда показывать редактор');
  CreateDesignPropertyTranslateLocal('dgTitles','Названия');
  CreateDesignPropertyTranslateLocal('dgIndicator','Индикатор');
  CreateDesignPropertyTranslateLocal('dgColumnResize','Изменять размеры колонок');
  CreateDesignPropertyTranslateLocal('dgColLines','Линии по колонкам');
  CreateDesignPropertyTranslateLocal('dgRowLines','Линии по строкам');
  CreateDesignPropertyTranslateLocal('dgTabs','Преход по TAB');
  CreateDesignPropertyTranslateLocal('dgRowSelect','Выделять строку');
  CreateDesignPropertyTranslateLocal('dgAlwaysShowSelection','Всегда показывать выделение');
  CreateDesignPropertyTranslateLocal('dgConfirmDelete','Вопрос при удалении');
  CreateDesignPropertyTranslateLocal('dgCancelOnExit','Отмена при выходе');
  CreateDesignPropertyTranslateLocal('dgMultiSelect','Мультивыделение');
  CreateDesignPropertyTranslateLocal('ConfirmDelete','Подтверждать удаление');
  CreateDesignPropertyTranslateLocal('Hints','Подсказки');
  CreateDesignPropertyTranslateLocal('DataField','Поле данных');
  CreateDesignPropertyTranslateLocal('AutoDisplay','Автодисплей');
  CreateDesignPropertyTranslateLocal('QuickDraw','Быстрая перерисовка');
  CreateDesignPropertyTranslateLocal('ValueChecked','Значение выбранного');
  CreateDesignPropertyTranslateLocal('ValueUnchecked','Значение не выбранного');
  CreateDesignPropertyTranslateLocal('Values','Значения');
  CreateDesignPropertyTranslateLocal('CellSelected','Выделенная ячейка');
  CreateDesignPropertyTranslateLocal('RowHeight','Высота строки');
  CreateDesignPropertyTranslateLocal('RowSelected','Выделять строку');
  CreateDesignPropertyTranslateLocal('RowSizing','Изменяемая высота строки');
  CreateDesignPropertyTranslateLocal('SelectedCells','Выделенные ячейки');
  CreateDesignPropertyTranslateLocal('TitleCellMouseDown','Шрифт при нажатии кнопкой мыши');
  CreateDesignPropertyTranslateLocal('maLeftToRight','Слева направо');
  CreateDesignPropertyTranslateLocal('maRightToLeft','Справа налево');
  CreateDesignPropertyTranslateLocal('maTopToBottom','Сверху вниз');
  CreateDesignPropertyTranslateLocal('maBottomToTop','Снизу вверх');
  CreateDesignPropertyTranslateLocal('maNone','Нет');
  CreateDesignPropertyTranslateLocal('BkColor','Цвет заднего плана');
  CreateDesignPropertyTranslateLocal('BlendColor','Цвет переднего плана');
  CreateDesignPropertyTranslateLocal('DrawingStyle','Стиль рисования');
  CreateDesignPropertyTranslateLocal('ImageType','Тип картинок');
  CreateDesignPropertyTranslateLocal('Masked','Маска');
  CreateDesignPropertyTranslateLocal('Interval','Интервал');
  CreateDesignPropertyTranslateLocal('ofReadOnly','Показывать флажок "Только чтение"');
  CreateDesignPropertyTranslateLocal('ofOverwritePrompt','Задавать вопрос при перезаписи');
  CreateDesignPropertyTranslateLocal('ofHideReadOnly','Скрыть флажок "Только чтение"');
  CreateDesignPropertyTranslateLocal('ofNoChangeDir','Не изменять директорию');
  CreateDesignPropertyTranslateLocal('ofShowHelp','Показывать помощь');
  CreateDesignPropertyTranslateLocal('ofNoValidate','Отключение проверки на неверные символы');
  CreateDesignPropertyTranslateLocal('ofAllowMultiSelect','Разрешить мультивыбор');
  CreateDesignPropertyTranslateLocal('ofExtensionDifferent','Запоминать другое расширени');
  CreateDesignPropertyTranslateLocal('ofPathMustExist','Проверять есть ли такой путь');
  CreateDesignPropertyTranslateLocal('ofCreatePrompt','Проверять есть ли такой файл');
  CreateDesignPropertyTranslateLocal('ofShareAware','Позволять выбирать файлы используемые совместно');
  CreateDesignPropertyTranslateLocal('ofNoReadOnlyReturn','Проверять файлы "Только для чтения"');
  CreateDesignPropertyTranslateLocal('ofNoTestFileCreate','Проверять если доступ на создание файла');
  CreateDesignPropertyTranslateLocal('ofNoNetworkButton','Непоказывать кнопку сети');
  CreateDesignPropertyTranslateLocal('ofNoLongNames','Не использовать длинные имена');
  CreateDesignPropertyTranslateLocal('ofOldStyleDialog','Старый стиль диалога');
  CreateDesignPropertyTranslateLocal('ofEnableSizing','Включить изменение размеров');
  CreateDesignPropertyTranslateLocal('ofFileMustExist','Проверка на существование файла');
  CreateDesignPropertyTranslateLocal('DefaultExt','Расширение по умолчанию');
  CreateDesignPropertyTranslateLocal('Filter','Фильтр');
  CreateDesignPropertyTranslateLocal('FilterIndex','Индекс фильтра');
  CreateDesignPropertyTranslateLocal('InitialDir','Текущая директория при открытии');
  CreateDesignPropertyTranslateLocal('Title','Название');
  CreateDesignPropertyTranslateLocal('fdAnsiOnly','Показывать только шрифты потдерживающие Windows-кодировку');
  CreateDesignPropertyTranslateLocal('fdTrueTypeOnly','Показывать только TrueType шрифты');
  CreateDesignPropertyTranslateLocal('fdEffects','Показывать эффекты');
  CreateDesignPropertyTranslateLocal('fdFixedPitchOnly','Показывать только FixedPitch шрифты');
  CreateDesignPropertyTranslateLocal('fdForceFontExist','Проверять есть ли такой шрифт');
  CreateDesignPropertyTranslateLocal('fdNoOEMFonts','Не показывать OEM шрифты');
  CreateDesignPropertyTranslateLocal('fdNoSizeSel','Не показывать изменеия размеров');
  CreateDesignPropertyTranslateLocal('fdNoStyleSel','Не показывать стиль выделения');
  CreateDesignPropertyTranslateLocal('fdNoVectorFonts','Не показывать векторные шрифты');
  CreateDesignPropertyTranslateLocal('fdShowHelp','Показывать помощь');
  CreateDesignPropertyTranslateLocal('fdWysiwyg','Показывать шрифты принтера и экрана');
  CreateDesignPropertyTranslateLocal('fdLimitSize','Ограничение размера');
  CreateDesignPropertyTranslateLocal('fdApplyButton','Кнопка применить');
  CreateDesignPropertyTranslateLocal('Device','Устройство');
  CreateDesignPropertyTranslateLocal('MaxFontSize','Макс.размер шрифта');
  CreateDesignPropertyTranslateLocal('MinFontSize','Мин.размер шрифта');

  CreateDesignPropertyTranslateLocal('cdFullOpen','Открывать полностью');
  CreateDesignPropertyTranslateLocal('cdPreventFullOpen','Запретить выбор дополнительных цветов');
  CreateDesignPropertyTranslateLocal('cdShowHelp','Показывать помощь');
  CreateDesignPropertyTranslateLocal('CustomColors','Выборочные цвета');
  CreateDesignPropertyTranslateLocal('poPrintToFile','Печать в файл');
  CreateDesignPropertyTranslateLocal('poPageNums','Количество страниц');
  CreateDesignPropertyTranslateLocal('poSelection','Выделение');
  CreateDesignPropertyTranslateLocal('poWarning','Предупреждение');
  CreateDesignPropertyTranslateLocal('poHelp','Помощь');
  CreateDesignPropertyTranslateLocal('poDisablePrintToFile','Отключить печать в файл');
  CreateDesignPropertyTranslateLocal('Copies','Копии');
  CreateDesignPropertyTranslateLocal('FromPage','От страницы');
  CreateDesignPropertyTranslateLocal('MaxPage','Макс.страниц');
  CreateDesignPropertyTranslateLocal('MinPage','Мин.страниц');
  CreateDesignPropertyTranslateLocal('PrintRange','Область печати');
  CreateDesignPropertyTranslateLocal('PrintToFile','Печать в файл');
  CreateDesignPropertyTranslateLocal('ToPage','До страницы');
  CreateDesignPropertyTranslateLocal('frDown','Вниз');
  CreateDesignPropertyTranslateLocal('frFindNext','Искать далее');
  CreateDesignPropertyTranslateLocal('frHideMatchCase','Скрыть проверку на регистр');
  CreateDesignPropertyTranslateLocal('frHideWholeWord','Скрыть проверку слов целиком');
  CreateDesignPropertyTranslateLocal('frHideUpDown','Скрыть вверх-вниз');
  CreateDesignPropertyTranslateLocal('frMatchCase','Проверка на регистр');
  CreateDesignPropertyTranslateLocal('frDisableMatchCase','Отключить проверку на регистр');
  CreateDesignPropertyTranslateLocal('frDisableUpDown','Отключить проверку вверх-вниз');
  CreateDesignPropertyTranslateLocal('frDisableWholeWord','Отключить проверку слов целиком');
  CreateDesignPropertyTranslateLocal('frReplace','Кнопка замены');
  CreateDesignPropertyTranslateLocal('frReplaceAll','Кнопка заменить все');
  CreateDesignPropertyTranslateLocal('frWholeWord','Проверка слов целиком');
  CreateDesignPropertyTranslateLocal('frShowHelp','Показывать помощь');
  CreateDesignPropertyTranslateLocal('FindText','Искомый текст');
  CreateDesignPropertyTranslateLocal('ReplaceText','Текст замены');
  CreateDesignPropertyTranslateLocal('AutoEdit','Авторедактирование');
  CreateDesignPropertyTranslateLocal('nbFirst','В начало');
  CreateDesignPropertyTranslateLocal('nbPrior','Предыдущий');
  CreateDesignPropertyTranslateLocal('nbNext','Следующий');
  CreateDesignPropertyTranslateLocal('nbLast','В конец');
  CreateDesignPropertyTranslateLocal('nbInsert','Вставить');
  CreateDesignPropertyTranslateLocal('nbDelete','Удалить');
  CreateDesignPropertyTranslateLocal('nbEdit','Редактировать');
  CreateDesignPropertyTranslateLocal('nbPost','Применить');
  CreateDesignPropertyTranslateLocal('nbCancel','Отменить');
  CreateDesignPropertyTranslateLocal('nbRefresh','Обновить');
  CreateDesignPropertyTranslateLocal('AutoCalcFields','Авто вычисляемые поля');
  CreateDesignPropertyTranslateLocal('BufferChunks','Инкриментируемый буфер');
  CreateDesignPropertyTranslateLocal('CachedUpdates','Изменения в кэше');
  CreateDesignPropertyTranslateLocal('Database','База данных');
  CreateDesignPropertyTranslateLocal('DefaultIndex','Индекс по умолчанию');
  CreateDesignPropertyTranslateLocal('FieldDefs','Поля по умолчанию');
  CreateDesignPropertyTranslateLocal('Filtered','Отфильтровать');
  CreateDesignPropertyTranslateLocal('ForcedRefresh','Силовое обновление');
  CreateDesignPropertyTranslateLocal('IndexDefs','Индексы по умолчанию');
  CreateDesignPropertyTranslateLocal('IndexFieldNames','Имена полей индексов');
  CreateDesignPropertyTranslateLocal('IndexName','Имя индекса');
  CreateDesignPropertyTranslateLocal('MasterSource','Главный источник');
  CreateDesignPropertyTranslateLocal('MasterFields','Главный поля');
  CreateDesignPropertyTranslateLocal('ObjectView','Представление объекта');
  CreateDesignPropertyTranslateLocal('TableName','Имя таблицы');
  CreateDesignPropertyTranslateLocal('TableTypes','Типы таблиц');
  CreateDesignPropertyTranslateLocal('ttSystem','Системные');
  CreateDesignPropertyTranslateLocal('ttView','Представления');
  CreateDesignPropertyTranslateLocal('Transaction','Транзакция');
  CreateDesignPropertyTranslateLocal('UpdateObject','Объект изменения');

  CreateDesignPropertyTranslateLocal('ParamsCheck','Проверка параметров');
  CreateDesignPropertyTranslateLocal('ParamCheck','Проверка параметра');
  CreateDesignPropertyTranslateLocal('Params','Параметры');
  CreateDesignPropertyTranslateLocal('SQL','SQL');
  CreateDesignPropertyTranslateLocal('StoredProcName','Имя хранимой процедуры');
  CreateDesignPropertyTranslateLocal('Connected','Соеденить');
  CreateDesignPropertyTranslateLocal('DatabaseName','Имя базы данных');
  CreateDesignPropertyTranslateLocal('DefaultTransaction','Транзакция по умолчанию');
  CreateDesignPropertyTranslateLocal('IdleTimer','Таймер ожидания');
  CreateDesignPropertyTranslateLocal('LoginPrompt','Диалог соединения');
  CreateDesignPropertyTranslateLocal('SQLDialect','SQL диалект');
  CreateDesignPropertyTranslateLocal('TraceFlags','Флаги трассировки');
  CreateDesignPropertyTranslateLocal('tfQPrepare','Подготовка');
  CreateDesignPropertyTranslateLocal('tfQExecute','Запуск');
  CreateDesignPropertyTranslateLocal('tfQFetch','Выборка');
  CreateDesignPropertyTranslateLocal('tfError','Ошибка');
  CreateDesignPropertyTranslateLocal('tfStmt','Все SQL');
  CreateDesignPropertyTranslateLocal('tfConnect','Соединение');
  CreateDesignPropertyTranslateLocal('tfTransact','Транзакция');
  CreateDesignPropertyTranslateLocal('tfBlob','Двоичные');
  CreateDesignPropertyTranslateLocal('tfService','Сервис');
  CreateDesignPropertyTranslateLocal('tfMisc','Misc');
  CreateDesignPropertyTranslateLocal('DefaultAction','Действие по умолчанию');
  CreateDesignPropertyTranslateLocal('DefaultDatabase','База данных по умолчанию');
  CreateDesignPropertyTranslateLocal('DeleteSQL','SQL при удалении');
  CreateDesignPropertyTranslateLocal('InsertSQL','SQL при вставке');
  CreateDesignPropertyTranslateLocal('ModifySQL','SQL при изменении');
  CreateDesignPropertyTranslateLocal('RefreshSQL','SQL при обновлении');
  CreateDesignPropertyTranslateLocal('SelectSQL','SQL при выборке');
  CreateDesignPropertyTranslateLocal('GoToFirstRecordOnExecute','Переходить на первую запись при запуске');
  CreateDesignPropertyTranslateLocal('Events','События');
  CreateDesignPropertyTranslateLocal('Registered','Зарегистриваны');
  CreateDesignPropertyTranslateLocal('Break','Перенос');
  CreateDesignPropertyTranslateLocal('ImageIndex','Индекс картинки');
  CreateDesignPropertyTranslateLocal('RadioItem','Совместный выбор');
  CreateDesignPropertyTranslateLocal('ShortCut','Горячая клавиша');
  CreateDesignPropertyTranslateLocal('SubMenuImages','Список картинок для этого меню');
  CreateDesignPropertyTranslateLocal('Bevel','Стиль бордюра');
  CreateDesignPropertyTranslateLocal('HorizontalOnly','Только горизонтально');
  CreateDesignPropertyTranslateLocal('ParentBitmap','Наследовать картинку');
  CreateDesignPropertyTranslateLocal('ButtonStyle','Стиль кнопки');
  CreateDesignPropertyTranslateLocal('DropDownRows','Количество выпадающих строк');
  CreateDesignPropertyTranslateLocal('Expanded','Развернутый');
  CreateDesignPropertyTranslateLocal('FieldName','Имя поля');
  CreateDesignPropertyTranslateLocal('PickList','Выпадающий список');
  CreateDesignPropertyTranslateLocal('FieldNames','Список полей');
  CreateDesignPropertyTranslateLocal('FieldValues','Список значений');

  CreateDesignPropertyTranslateLocal('ixPrimary','Главный');
  CreateDesignPropertyTranslateLocal('ixUnique','Уникальный');
  CreateDesignPropertyTranslateLocal('ixDescending','Обратный');
  CreateDesignPropertyTranslateLocal('ixCaseInsensitive','С проверкой на регистр');
  CreateDesignPropertyTranslateLocal('ixExpression','Вычисляемый');
  CreateDesignPropertyTranslateLocal('ixNonMaintained','Не обновляемый');
  CreateDesignPropertyTranslateLocal('CaseInsFields','Поле с проверкой на регистр');
  CreateDesignPropertyTranslateLocal('DescFields','Поля с обратной сортировкой');
  CreateDesignPropertyTranslateLocal('Expression','Выражения');
  CreateDesignPropertyTranslateLocal('Fields','Поля');
  CreateDesignPropertyTranslateLocal('GroupingLevel','Уровень группировки');
  CreateDesignPropertyTranslateLocal('Source','Исходник');
  CreateDesignPropertyTranslateLocal('CustomConstraint','Другие ограничения');
  CreateDesignPropertyTranslateLocal('ErrorMessage','Сообщение при ошибке');
  CreateDesignPropertyTranslateLocal('FromDictionary','Проверка на ограничения');
  CreateDesignPropertyTranslateLocal('ImportedConstraint','Импортируемые ограничения');
  CreateDesignPropertyTranslateLocal('Attributes','Аттрибуты');
  CreateDesignPropertyTranslateLocal('faHiddenCol','Скрытые колонки');
  CreateDesignPropertyTranslateLocal('faReadOnly','Только чтение');
  CreateDesignPropertyTranslateLocal('faRequired','Требуемые');
  CreateDesignPropertyTranslateLocal('faLink','Связанные');
  CreateDesignPropertyTranslateLocal('faUnNamed','Без имени');
  CreateDesignPropertyTranslateLocal('faFixed','Фиксированные');
  CreateDesignPropertyTranslateLocal('ChildDefs','Дочерние установки');
  CreateDesignPropertyTranslateLocal('DataType','Тип данных');
  CreateDesignPropertyTranslateLocal('Precision','Точность');
  CreateDesignPropertyTranslateLocal('ParamType','Тип параметра');
  CreateDesignPropertyTranslateLocal('Value','Значение');
  CreateDesignPropertyTranslateLocal('DropDownMenu','Выпадающее меню');
  CreateDesignPropertyTranslateLocal('Grouped','Группировка');
  CreateDesignPropertyTranslateLocal('Marked','Маркировка');
  CreateDesignPropertyTranslateLocal('MenuItem','Элемент меню');

  CreateDesignPropertyTranslateLocal('Highlighted','Подсветка');
  CreateDesignPropertyTranslateLocal('PageIndex','Индекс страницы');
  CreateDesignPropertyTranslateLocal('TabVisible','Показ закладки');
  CreateDesignPropertyTranslateLocal('ExecProcName','Имя запускаемой процедуры');
  CreateDesignPropertyTranslateLocal('ExecProcParams','Параметры запускаемой процедуры');
  CreateDesignPropertyTranslateLocal('InterfaceName','Имя интерфейса');
  CreateDesignPropertyTranslateLocal('ReturnData','Набор возвращаемых данных');
  CreateDesignPropertyTranslateLocal('Condition','Условия');
  CreateDesignPropertyTranslateLocal('Visual','Визуальные параметры');
  CreateDesignPropertyTranslateLocal('Locate','Переход по условию');
  CreateDesignPropertyTranslateLocal('ParamName','Имя параметра');
  CreateDesignPropertyTranslateLocal('Type','Тип');

  // Events

  CreateDesignPropertyTranslateLocal('OnChanging','Во время изменения');
  CreateDesignPropertyTranslateLocal('OnChange','При изменении');
  CreateDesignPropertyTranslateLocal('OnPopup','При всплытии');
  CreateDesignPropertyTranslateLocal('OnExecute','При запуске');
  CreateDesignPropertyTranslateLocal('OnUpdate','При изменении');
  CreateDesignPropertyTranslateLocal('OnClick','При левом клике');
  CreateDesignPropertyTranslateLocal('OnContextPopup','При правом клике');
  CreateDesignPropertyTranslateLocal('OnDblClick','При двойном клике');
  CreateDesignPropertyTranslateLocal('OnMouseDown','При нажатии кнопки мыши');
  CreateDesignPropertyTranslateLocal('OnMouseMove','При движении мыши');
  CreateDesignPropertyTranslateLocal('OnMouseUp','При отпускании кнопки мыши');
  CreateDesignPropertyTranslateLocal('OnActivate','При активизации');
  CreateDesignPropertyTranslateLocal('OnClose','При закрытии');
  CreateDesignPropertyTranslateLocal('OnCloseQuery','При закрытии с запросом');
  CreateDesignPropertyTranslateLocal('OnCreate','При создании');
  CreateDesignPropertyTranslateLocal('OnDeactivate','При деактивизации');
  CreateDesignPropertyTranslateLocal('OnDestroy','При уничтожении');
  CreateDesignPropertyTranslateLocal('OnHelp','При вызове помощи');
  CreateDesignPropertyTranslateLocal('OnHide','При скрытии');
  CreateDesignPropertyTranslateLocal('OnKeyDown','При нажатии клавиши');
  CreateDesignPropertyTranslateLocal('OnKeyPress','При удерживании клавиши');
  CreateDesignPropertyTranslateLocal('OnKeyUp','При отпускании клавиши');
  CreateDesignPropertyTranslateLocal('OnPaint','При рисовании');
  CreateDesignPropertyTranslateLocal('OnResize','При изменении размеров');
  CreateDesignPropertyTranslateLocal('OnShortCut','При нажатии горячей клавиши');
  CreateDesignPropertyTranslateLocal('OnShow','При показе');
  CreateDesignPropertyTranslateLocal('OnEnter','При входе фокуса');
  CreateDesignPropertyTranslateLocal('OnExit','При выходе фокуса');
  CreateDesignPropertyTranslateLocal('OnDrawIntem','При рисовании элемента');
  CreateDesignPropertyTranslateLocal('OnDropDown','При выпадании');
  CreateDesignPropertyTranslateLocal('OnScroll','При прокрутке');
  CreateDesignPropertyTranslateLocal('OnColumnMoved','После перемещения колонок');
  CreateDesignPropertyTranslateLocal('OnDrawCell','При рисовании ячейки');
  CreateDesignPropertyTranslateLocal('OnGetEditMask','При получении маски');
  CreateDesignPropertyTranslateLocal('OnGetEditText','При получении текста');
  CreateDesignPropertyTranslateLocal('OnRowMoved','После перемещения строк');
  CreateDesignPropertyTranslateLocal('OnSelectCell','При выборе ячейки');
  CreateDesignPropertyTranslateLocal('OnSetEditText','При задании текста');
  CreateDesignPropertyTranslateLocal('OnProgress','При прогрессе');
  CreateDesignPropertyTranslateLocal('OnClickCheck','При клике с выбором');
  CreateDesignPropertyTranslateLocal('OnMoved','После перемещения');
  CreateDesignPropertyTranslateLocal('OnСhanging','При изменении');
  CreateDesignPropertyTranslateLocal('OnСhangingEx','При расширенном изменении');
  CreateDesignPropertyTranslateLocal('OnDrawTab','При рисовании закладок');
  CreateDesignPropertyTranslateLocal('OnGetImageIndex','При получении индекса картинки');
  CreateDesignPropertyTranslateLocal('OnProtectChange','При защищенном изменении');
  CreateDesignPropertyTranslateLocal('OnSaveClipboard','При сохранении в буфер');
  CreateDesignPropertyTranslateLocal('OnOpen','При открытии');
  CreateDesignPropertyTranslateLocal('OnCloseUp','При закрытии вверх');
  CreateDesignPropertyTranslateLocal('OnStart','При старте');
  CreateDesignPropertyTranslateLocal('OnStop','При остановке');
  CreateDesignPropertyTranslateLocal('OnUserInput','При вводе пользователя');
  CreateDesignPropertyTranslateLocal('OnGetMonthInfo','При получении информации о месяце');
  CreateDesignPropertyTranslateLocal('OnCollapsed','После сворачивания');
  CreateDesignPropertyTranslateLocal('OnCompare','При сравнении');
  CreateDesignPropertyTranslateLocal('OnDeletion','При удалении');
  CreateDesignPropertyTranslateLocal('OnEdited','После редактирования');
  CreateDesignPropertyTranslateLocal('OnEditing','При редактировании');
  CreateDesignPropertyTranslateLocal('OnExpanded','После разворачивания');
  CreateDesignPropertyTranslateLocal('OnExpanding','При разворачивании');
  CreateDesignPropertyTranslateLocal('OnGetSelectedIndex','При получении выделенного индекса картинки');
  CreateDesignPropertyTranslateLocal('OnTimer','При срабатывании таймера');
  CreateDesignPropertyTranslateLocal('OnPostClick','При нажатии на кнопку');
  CreateDesignPropertyTranslateLocal('OnObjectMove','При движении объекта');
  CreateDesignPropertyTranslateLocal('OnCanClose','При возможности закрыть');
  CreateDesignPropertyTranslateLocal('OnFolderChange','При изменении директории');
  CreateDesignPropertyTranslateLocal('OnIncludeItem','При включении элемента');
  CreateDesignPropertyTranslateLocal('OnSelectionChange','При изменении выделения');
  CreateDesignPropertyTranslateLocal('OnTypeChange','При изменении типа');
  CreateDesignPropertyTranslateLocal('OnApply','При применении');
  CreateDesignPropertyTranslateLocal('OnFind','При поиске');
  CreateDesignPropertyTranslateLocal('OnReplace','При замене');
  CreateDesignPropertyTranslateLocal('OnDataChange','При изменении данных');
  CreateDesignPropertyTranslateLocal('OnStateChange','При изменении статуса');
  CreateDesignPropertyTranslateLocal('OnUpdateData','При изменении данных');
  CreateDesignPropertyTranslateLocal('OnCellClick','При клике на ячейку');
  CreateDesignPropertyTranslateLocal('OnColEnter','При входе на колонку');
  CreateDesignPropertyTranslateLocal('OnColExit','При выходе с колонке');
  CreateDesignPropertyTranslateLocal('OnEditButtonClick','При клике на кнопку редактирования');
  CreateDesignPropertyTranslateLocal('OnTitleClick','При клике на название');
  CreateDesignPropertyTranslateLocal('OnDrawItem','При рисовании элемента');

  CreateDesignPropertyTranslateLocal('AfterCancel','После отмены');
  CreateDesignPropertyTranslateLocal('AfterClose','После закрытия');
  CreateDesignPropertyTranslateLocal('AfterDatabaseDisconnect','После отсоединения от базы');
  CreateDesignPropertyTranslateLocal('AfterDelete','После удаления');
  CreateDesignPropertyTranslateLocal('AfterEdit','После редактирования');
  CreateDesignPropertyTranslateLocal('AfterInsert','После вставки');
  CreateDesignPropertyTranslateLocal('AfterOpen','После открытия');
  CreateDesignPropertyTranslateLocal('AfterPost','После применения');
  CreateDesignPropertyTranslateLocal('AfterRefresh','После обновления');
  CreateDesignPropertyTranslateLocal('AfterScroll','После прокрутки');
  CreateDesignPropertyTranslateLocal('AfterTransactionEnd','После окончания транцакции');
  CreateDesignPropertyTranslateLocal('BeforeCancel','Перед отменой');
  CreateDesignPropertyTranslateLocal('BeforeClose','Перед закрытием');
  CreateDesignPropertyTranslateLocal('BeforeDatabaseDisconnect','Перед отсоединением от базы');
  CreateDesignPropertyTranslateLocal('BeforeDelete','Перед удалением');
  CreateDesignPropertyTranslateLocal('BeforeEdit','Перед редактированием');
  CreateDesignPropertyTranslateLocal('BeforeInsert','Перед вставкой');
  CreateDesignPropertyTranslateLocal('BeforeOpen','Перед открытием');
  CreateDesignPropertyTranslateLocal('BeforePost','Перед применением');
  CreateDesignPropertyTranslateLocal('BeforeRefresh','Перед обновлением');
  CreateDesignPropertyTranslateLocal('BeforeScroll','Перед прокруткой');
  CreateDesignPropertyTranslateLocal('BeforeTransactionEnd','Перед окончанием транзакции');
  CreateDesignPropertyTranslateLocal('DatabaseFree','Перед уничтожением базы');
  CreateDesignPropertyTranslateLocal('TransactionFree','Перед уничтожением транзакции');
  CreateDesignPropertyTranslateLocal('OnCalcFields','При вычислении полей');
  CreateDesignPropertyTranslateLocal('OnDeleteError','При ошибке удаления');
  CreateDesignPropertyTranslateLocal('OnEditError','При ошибке редактирования');
  CreateDesignPropertyTranslateLocal('OnFilterRecord','При фильтровании записей');
  CreateDesignPropertyTranslateLocal('OnNewRecord','При новой записи');
  CreateDesignPropertyTranslateLocal('OnPostError','При ошибке применения');
  CreateDesignPropertyTranslateLocal('OnUpdateError','При ошибке изменения');
  CreateDesignPropertyTranslateLocal('OnUpdateRecord','При изменении записи');
  CreateDesignPropertyTranslateLocal('AfterConnect','После соединения');
  CreateDesignPropertyTranslateLocal('AfterDisconnect','После отсоединения');
  CreateDesignPropertyTranslateLocal('BeforeDisconnect','Перед отсоединением');
  CreateDesignPropertyTranslateLocal('BeforeConnect','Перед соединением');
  CreateDesignPropertyTranslateLocal('OnDialectDowngradeWarning','При неверном диалекте');
  CreateDesignPropertyTranslateLocal('OnIdleTimer','При срабатывании ожидающего таймера');
  CreateDesignPropertyTranslateLocal('OnLogin','При информации о соединении');
  CreateDesignPropertyTranslateLocal('OnSQLChanging','Во время изменения SQL');
  CreateDesignPropertyTranslateLocal('OnSQL','При SQL');
  CreateDesignPropertyTranslateLocal('OnEventAlert','При срабатывании события');
end;
...
begin
  ...
  CreateDesignPaletteButtonLocal(DPH,'Главное меню',TiMainMenu,0,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Всплывающее меню',TiPopupMenu,1,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Метка',TiLabel,2,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода',TiEdit,3,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Многострочное поле ввода',TiMemo,4,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Кнопка',TiButton,5,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Флажок',TiCheckBox,6,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Переключатель',TiRadioButton,7,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Список',TiListBox,8,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Выпадающий список',TiComboBox,9,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Прокрутка',TiScrollBar,10,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Группа',TiGroupBox,11,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Группа переключателей',TiRadioGroup,12,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Панель',TiPanel,13,dm.ILStandart);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameAdditional,ConstDesignPaletteHintAdditional);
  CreateDesignPaletteButtonLocal(DPH,'Кнопка с картинкой',TiBitBtn,15,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Быстрая кнопка',TiSpeedButton,16,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода с маской',TiMaskEdit,17,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Сетка со строками',TiStringGrid,18,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Рисуемая сетка',TiDrawGrid,19,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Картинка',TiImage,20,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Фигуры',TiShape,21,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Обрамление',TiBevel,22,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Прокручиваемый ящик',TiScrollBox,23,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Список с выбором',TiCheckListBox,24,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Сплиттер',TiSplitter,25,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Статичный текст',TiStaticText,26,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Контрол бар',TiControlBar,27,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'События приложения',TiApplicationEvents,28,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'График',TiChart,80,dm.ILStandart);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameWin32,ConstDesignPaletteHintWin32);
  CreateDesignPaletteButtonLocal(DPH,'Закладки',TiTabControl,29,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Закладки',TiPageControl,30,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Список картинок',TiImageList,31,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Расширенное поле ввода',TiRichEdit,32,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Ползунок',TiTrackBar,33,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Прогресс',TiProgressBar,34,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Вверх-вниз',TiUpDown,35,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Горячая клавиша',TiHotKey,36,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Анимация',TiAnimate,37,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода даты и времени',TiDateTimePicker,38,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Каледарь',TiMonthCalendar,39,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Дерево',TiTreeView,40,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Расширенный список',TiListView,41,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Панель статуса',TiStatusBar,42,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Панель инструментов',TiToolBar,43,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Крутая панель',TiCoolBar,44,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Панель прокрутки',TiPageScroller,45,dm.ILStandart);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameSystem,ConstDesignPaletteHintSystem);
  CreateDesignPaletteButtonLocal(DPH,'Таймер',TiTimer,46,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Ящик для рисования',TiPaintBox,47,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Медиа проигрыватель',TiMediaPlayer,48,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'OLE контейнер',TiOleContainer,49,dm.ILStandart);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameDialogs,ConstDesignPaletteHintDialogs);
  CreateDesignPaletteButtonLocal(DPH,'Диалог открытия',TiOpenDialog,58,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Диалог сохранения',TiSaveDialog,64,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Диалог открытия картинки',TiOpenPictureDialog,59,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Диалог сохранения картинки',TiSavePictureDialog,65,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Диалог выбора шрифта',TiFontDialog,57,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Диалог выбора цвета',TiColorDialog,60,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Диалог выбора принтера',TiPrintDialog,61,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Диалог настройки принтера',TiPrinterSetupDialog,62,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Диалог поиска',TiFindDialog,56,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Диалог замены',TiReplaceDialog,63,dm.ILStandart);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameDataControls,ConstDesignPaletteHintDataControls);
  CreateDesignPaletteButtonLocal(DPH,'Источник данных',TiDataSource,54,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Набор данных клиента',TiClientDataSet,79,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'Представление данных',TiDBGrid,55,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Навигатор',TiDBNavigator,76,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Метка',TiDBText,66,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Поле ввода',TiDBEdit,70,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Многострочное поле ввода',TiDBMemo,75,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Картинка',TiDBImage,71,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Список',TiDBListBox,72,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Выпадающий список',TiDBComboBox,68,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Флажок',TiDBCheckBox,67,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Группа переключателей',TiDBRadioGroup,77,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД Расширенное поле ввода',TiDBRichEdit,78,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД график',TiDBChart,81,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'БД дерево',TiVirtualDBTree,40,dm.ILStandart);
  {CreateDesignPaletteButtonLocal(DPH,'ываывфа',TClientDataSet,-1,dm.ILStandart);
  CreateDesignPaletteButtonLocal(DPH,'ываывфа',TDCOMConnection,-1,dm.ILStandart);   }

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameInterBase,ConstDesignPaletteHintInterBase);
  CreateDesignPaletteButtonLocal(DPH,'Таблица',TiIBTable,0,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'Запрос',TiIBQuery,1,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'Хранимая процедура',TiIBStoredProc,2,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'База данных',TiIBDatabase,3,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'Транзакция',TiIBTransaction,4,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'Обновляемый SQL',TiIBUpdateSql,5,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'Набор данных',TiIBDataSet,6,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'SQL',TiIBSQL,7,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'Информация о базе',TiIBDataBaseInfo,8,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'Монитор SQL',TiIBSqlMonitor,9,dm.ILInterbase);
  CreateDesignPaletteButtonLocal(DPH,'События',TiIBEvents,10,dm.ILInterbase);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameInterface,ConstDesignPaletteHintInterface);
  CreateDesignPaletteButtonLocal(DPH,'Интерфейс справочника',TiRBookInterface,0,dm.ILStbasis);
  CreateDesignPaletteButtonLocal(DPH,'Интерфейс отчета',TiReportInterface,1,dm.ILStbasis);
  CreateDesignPaletteButtonLocal(DPH,'Интерфейс документа',TiDocumentInterface,2,dm.ILStbasis);
  CreateDesignPaletteButtonLocal(DPH,'Интерфейс журнала',TiJournalInterface,3,dm.ILStbasis);
  CreateDesignPaletteButtonLocal(DPH,'Интерфейс сервиса',TiServiceInterface,4,dm.ILStbasis);
  CreateDesignPaletteButtonLocal(DPH,'Интерфейс помощника',TiWizardInterface,5,dm.ILStbasis);
  CreateDesignPaletteButtonLocal(DPH,'Неизвестный интерфейс',TiNoneInterface,6,dm.ILStbasis);
  CreateDesignPaletteButtonLocal(DPH,'Набор данных в памяти',TitsvMemoryData,18,dm.ILRx);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameHtml,ConstDesignPaletteHintHtml);
  CreateDesignPaletteButtonLocal(DPH,'Страница Html',TiTsvHtmlPage,0,dm.ilTsvHtml,[ttiHelp]);
  CreateDesignPaletteButtonLocal(DPH,'Фрейм Html',TitsvHtmlFrame,1,dm.ilTsvHtml,[ttiHelp]);
  CreateDesignPaletteButtonLocal(DPH,'Метка Html',TiTsvHtmlLabel,2,dm.ilTsvHtml,[ttiHelp]);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameTsv,ConstDesignPaletteHintTsv);
  CreateDesignPaletteButtonLocal(DPH,'Выпадающий список цветов',TiTsvColorBox,0,dm.ILTsv);
  CreateDesignPaletteButtonLocal(DPH,'Расширенное представление данных',TiTsvDBGrid,1,dm.ILTsv);
  CreateDesignPaletteButtonLocal(DPH,'Расширенный список',TiTsvListBox,2,dm.ILTsv);
  CreateDesignPaletteButtonLocal(DPH,'Хранилище',TiTsvStorage,3,dm.ILTsv);
  CreateDesignPaletteButtonLocal(DPH,'Поворачиваемая метка',TiTsvAngelLabel,4,dm.ILTsv);
  CreateDesignPaletteButtonLocal(DPH,'Градиентная заливка',TiTsvGradient,5,dm.ILTsv);
  CreateDesignPaletteButtonLocal(DPH,'Расширенная подсказка',TiTsvHintEx,6,dm.ILTsv);
  CreateDesignPaletteButtonLocal(DPH,'XML документ',TitsvXMLDocument,7,dm.ILTsv);
  CreateDesignPaletteButtonLocal(DPH,'Строки',TitsvStringList,8,dm.ILTsv);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameFastReport,ConstDesignPaletteHintFastReport);
  CreateDesignPaletteButtonLocal(DPH,'Отчет',TifrReport,0,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Совмещенный отчет',TifrCompositeReport,1,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Набор данных',TifrDBDataset,2,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Набор пользовательских данных',TifrUserDataset,3,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Экспорт в текст',TifrTextExport,4,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Экспорт в RTF',TifrRtfExport,5,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Экспорт в CSV',TifrCSVExport,6,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Экспорт в HTML',TifrHTMExport,7,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Предварительный просмотр',TifrPreview,8,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Печать таблицы',TifrPrintTable,9,dm.ILFastReport,[ttiReport]);
  CreateDesignPaletteButtonLocal(DPH,'Печать сетки',TifrPrintGrid,10,dm.ILFastReport,[ttiReport]);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameRx,ConstDesignPaletteHintRx);
  CreateDesignPaletteButtonLocal(DPH,'Поле с кнопкой',TiComboEdit,0,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода имя файла',TiFilenameEdit,1,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода директории',TiDirectoryEdit,2,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода даты',TiDateEdit,3,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода суммы',TiRxCalcEdit,4,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода денег',TiCurrencyEdit,5,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Выбор шрифта',TiFontComboBox,6,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Выбор цвета',TiColorComboBox,7,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Метка',TiRxLabel,8,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Расширенное многострочное поле ввода',TiRxRichEdit,9,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Часы',TiRxClock,10,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Анимация',TiAnimatedImage,11,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Сетка',TiRxDrawGrid,12,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Быстрая кнопка',TiRxSpeedButton,13,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'GIF Анимация',TiRxGifAnimator,14,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Калькулятор',TiRxCalculator,15,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Список таймеров',TiRxTimerList,16,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Монитор каталога',TiRxFolderMonitor,17,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Набор данных в памяти',TiRxMemoryData,18,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Сетка набора данных',TiRxDBGrid,19,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Список просмотра набора данных',TiRxDBLookupList,20,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Выпадающий список просмотра набора данных',TiRxDBLookupCombo,21,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Поле просмотра набора данных',TiRxLookupEdit,22,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода даты в набор данных',TiDBDateEdit,23,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Поле ввода суммы в набор данных',TiRxDBCalcEdit,24,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Выпадающее поле ввода данных',TiRxDBComboEdit,25,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Расширенное многострочное поле ввода данных',TiRxDBRichEdit,26,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Статусная метка',TiDBStatusLabel,27,dm.ILRx);
  CreateDesignPaletteButtonLocal(DPH,'Выпадающий список ввода данных',TiRxDbComboBox,28,dm.ILRx);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameIndy,ConstDesignPaletteHintIndy);
  CreateDesignPaletteButtonLocal(DPH,'Клиент Http',TiIdHttp,0,dm.ILIndy);

  DPH:=CreateDesignPaletteLocal(ConstDesignPaletteNameAbbrevia,ConstDesignPaletteHintAbbrevia);
  CreateDesignPaletteButtonLocal(DPH,'Архиватор Zip',TiAbZipper,0,dm.ILAbbrevia);
...
begin
  ...
  CreateInterpreterClassLocal(TFont);
  ...
  CreateInterpreterClassPropertyLocal(h,'Cursor',TScreen_Read_Cursor,nil,PP('TCursor',varInteger),
                                      TScreen_Write_Cursor,ArrPP(['Value: TCursor',varInteger]),false,'Курсор');
  ...
  CreateInterpreterClassLocal(TBlobField);
...
{  CreateInterpreterFunLocal('AnsiStrIComp',SysUtils_AnsiStrIComp,ArrPP(['S1: PChar',varString,'S2: PChar',varString]),PP('Integer',varInteger));
  ...
  CreateInterpreterFunLocal('ShowErrorEx',stbasis_ShowErrorEx,ArrPP(['Mess: String',varString]),PP('Integer',varInteger),'Функция выводит сообщение об ошибке');
  CreateInterpreterFunLocal('ShowErrorTest1',stbasis_ShowErrorEx,ArrPP(['Mess: String',varString]),PP('Integer',varInteger),'Функция выводит сообщение об ошибке');
  ...
  CreateInterpreterFunLocal('CreateProgressBar',stbasis_CreateProgressBar,ArrPP(['Min: Integer',varInteger,'Max: Integer',varInteger,'Hint: String',varString,'Color: TColor',varInteger]),PP('THandle',varInteger),'Функция создания прогресс-бара');
  CreateInterpreterFunLocal('FreeProgressBar',stbasis_FreeProgressBar,ArrPP(['ProgressBarHandle: THandle',varInteger]),PP('Boolean',varBoolean),'Функция уничтожения прогресс-бара');
  CreateInterpreterFunLocal('SetProgressBarStatus',stbasis_SetProgressBarStatus,ArrPP(['ProgressBarHandle: THandle',varInteger,'Progress: Integer',varInteger,'Max: Integer',varInteger,'Hint: String',varString]),nil,'Процедура задания параметров прогресс-бара');
  ...
  CreateInterpreterFunLocal('isExistsParam',stbasis_isExistsParam,ArrPP(['Section: string',varString,'Param: string',varString]),PP('Boolean',varBoolean),'Функция проверки параметра');
  CreateInterpreterFunLocal('WriteParam',stbasis_WriteParam,ArrPP(['const Section: string',varString,'Param: string',varString,'Value: Variant',varVariant]),nil,'Процедура записи параметра');
  CreateInterpreterFunLocal('ReadParam',stbasis_ReadParam,ArrPP(['const Section: string',varString,'Param: string',varString,'Default: Variant',varVariant]),PP('Variant',varVariant),'Функция чтения параметра');
  CreateInterpreterFunLocal('ClearParams',stbasis_ClearParams,nil,nil,'Процедура очистки всех параметров');
  CreateInterpreterFunLocal('SaveParams',stbasis_SaveParams,nil,nil,'Процедура записи всех параметров в базу');
  CreateInterpreterFunLocal('EraseParams',stbasis_EraseParams,ArrPP(['const Section: string',varString]),PP('Boolean',varBoolean),'Функция удаления секции параметров');

  CreateInterpreterFunLocal('GetDateTimeFromServer',stbasis_GetDateTimeFromServer,nil,PP('TDateTime',varDate),'Функция получения даты и времени с сервера');
  CreateInterpreterFunLocal('ViewEnterPeriod',stbasis_ViewEnterPeriod,ArrPP(['var DateBegin: TDateTime',varByRef,'var DateEnd: TDateTime',varByRef,'TypePeriod: TTypeEnterPeriod',varInteger,'LoadAndSave: Boolean',varBoolean]),PP('Boolean',varBoolean),'Функция получения даты в окне выбора периода');
  CreateInterpreterFunLocal('GetGenId',stbasis_GetGenId,ArrPP(['DB: TIBDatabase',varObject,'TableName: String',varString,'Increment: Integer',varInteger]),PP('Integer',varInteger),'Функция генерации уникального ИД');
  CreateInterpreterFunLocal('GetUserId',stbasis_GetUserId,nil,PP('Integer',varInteger),'Функция получения ИД текущего пользователя');
  CreateInterpreterFunLocal('GetUniqueId',stbasis_GetUniqueId,nil,PP('String',varString),'Функция получения уникального ИД');
  CreateInterpreterFunLocal('ChangeString',stbasis_ChangeString,ArrPP(['S: string',varString,'Old: string',varString,'New: string',varString]),PP('String',varString),'Функция замены подстроки в строке');
  CreateInterpreterFunLocal('FillWordsByString',stbasis_FillWordsByString,ArrPP(['S: string',varString,'Str: TStringList',varObject]),nil,'Функция заполнения слов из строки');
  CreateInterpreterFunLocal('GetTempDir',stbasis_GetTempDir,nil,PP('String',varString),'Функция получения временной директории');
  CreateInterpreterFunLocal('ExecSQL',stbasis_ExecSql,ArrPP(['DB: TIBDatabase',varObject,'SQL: String',varString]),nil,'Функция выполнения запросов в определенной БД');
...
begin
  // Forms
  CreateInterpreterVarLocal(ConstApplicationName,O2V(Application),C2V(TApplication),'TApplication','Приложение');
  CreateInterpreterVarLocal(ConstScreenName,O2V(Screen),C2V(TScreen),'TScreen','Экран');
