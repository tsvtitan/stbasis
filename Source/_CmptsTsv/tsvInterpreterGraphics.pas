...
uses SysUtils, UMainUnited, tsvInterpreterCore;
  ...
  { TFont }
procedure TFont_Create(var Value: Variant; Args: TArguments);
procedure TFont_Assign(var Value: Variant; Args: TArguments);
procedure TFont_Read_Handle(var Value: Variant; Args: TArguments);
procedure TFont_Write_Handle(const Value: Variant; Args: TArguments);
procedure TFont_Read_PixelsPerInch(var Value: Variant; Args: TArguments);
procedure TFont_Write_PixelsPerInch(const Value: Variant; Args: TArguments);
procedure TFont_Read_Charset(var Value: Variant; Args: TArguments);
procedure TFont_Write_Charset(const Value: Variant; Args: TArguments);
procedure TFont_Read_Color(var Value: Variant; Args: TArguments);
procedure TFont_Write_Color(const Value: Variant; Args: TArguments);
procedure TFont_Read_Height(var Value: Variant; Args: TArguments);
procedure TFont_Write_Height(const Value: Variant; Args: TArguments);
procedure TFont_Read_Name(var Value: Variant; Args: TArguments);
procedure TFont_Write_Name(const Value: Variant; Args: TArguments);
procedure TFont_Read_Pitch(var Value: Variant; Args: TArguments);
procedure TFont_Write_Pitch(const Value: Variant; Args: TArguments);
procedure TFont_Read_Size(var Value: Variant; Args: TArguments);
procedure TFont_Write_Size(const Value: Variant; Args: TArguments);
procedure TFont_Read_Style(var Value: Variant; Args: TArguments);
procedure TFont_Write_Style(const Value: Variant; Args: TArguments);

  { TPen }
procedure TPen_Create(var Value: Variant; Args: TArguments);
procedure TPen_Assign(var Value: Variant; Args: TArguments);
procedure TPen_Read_Handle(var Value: Variant; Args: TArguments);
procedure TPen_Write_Handle(const Value: Variant; Args: TArguments);
procedure TPen_Read_Color(var Value: Variant; Args: TArguments);
procedure TPen_Write_Color(const Value: Variant; Args: TArguments);
procedure TPen_Read_Mode(var Value: Variant; Args: TArguments);
procedure TPen_Write_Mode(const Value: Variant; Args: TArguments);
procedure TPen_Read_Style(var Value: Variant; Args: TArguments);
procedure TPen_Write_Style(const Value: Variant; Args: TArguments);
procedure TPen_Read_Width(var Value: Variant; Args: TArguments);
procedure TPen_Write_Width(const Value: Variant; Args: TArguments);

  { TBrush }
procedure TBrush_Create(var Value: Variant; Args: TArguments);
procedure TBrush_Assign(var Value: Variant; Args: TArguments);
procedure TBrush_Read_Bitmap(var Value: Variant; Args: TArguments);
procedure TBrush_Write_Bitmap(const Value: Variant; Args: TArguments);
procedure TBrush_Read_Handle(var Value: Variant; Args: TArguments);
procedure TBrush_Write_Handle(const Value: Variant; Args: TArguments);
procedure TBrush_Read_Color(var Value: Variant; Args: TArguments);
procedure TBrush_Write_Color(const Value: Variant; Args: TArguments);
procedure TBrush_Read_Style(var Value: Variant; Args: TArguments);
procedure TBrush_Write_Style(const Value: Variant; Args: TArguments);

  { TCanvas }
procedure TCanvas_Create(var Value: Variant; Args: TArguments);
procedure TCanvas_Arc(var Value: Variant; Args: TArguments);
procedure TCanvas_Chord(var Value: Variant; Args: TArguments);
procedure TCanvas_Draw(var Value: Variant; Args: TArguments);
procedure TCanvas_Ellipse(var Value: Variant; Args: TArguments);
procedure TCanvas_FloodFill(var Value: Variant; Args: TArguments);
procedure TCanvas_LineTo(var Value: Variant; Args: TArguments);
procedure TCanvas_Lock(var Value: Variant; Args: TArguments);
procedure TCanvas_MoveTo(var Value: Variant; Args: TArguments);
procedure TCanvas_Pie(var Value: Variant; Args: TArguments);
procedure TCanvas_Rectangle(var Value: Variant; Args: TArguments);
procedure TCanvas_Refresh(var Value: Variant; Args: TArguments);
procedure TCanvas_RoundRect(var Value: Variant; Args: TArguments);
procedure TCanvas_TextHeight(var Value: Variant; Args: TArguments);
procedure TCanvas_TextOut(var Value: Variant; Args: TArguments);
procedure TCanvas_TextWidth(var Value: Variant; Args: TArguments);
procedure TCanvas_TryLock(var Value: Variant; Args: TArguments);
procedure TCanvas_Unlock(var Value: Variant; Args: TArguments);
procedure TCanvas_Read_Handle(var Value: Variant; Args: TArguments);
procedure TCanvas_Write_Handle(const Value: Variant; Args: TArguments);
procedure TCanvas_Read_LockCount(var Value: Variant; Args: TArguments);
procedure TCanvas_Read_Brush(var Value: Variant; Args: TArguments);
procedure TCanvas_Write_Brush(const Value: Variant; Args: TArguments);
procedure TCanvas_Read_CopyMode(var Value: Variant; Args: TArguments);
procedure TCanvas_Write_CopyMode(const Value: Variant; Args: TArguments);
procedure TCanvas_Read_Font(var Value: Variant; Args: TArguments);
procedure TCanvas_Write_Font(const Value: Variant; Args: TArguments);
procedure TCanvas_Read_Pen(var Value: Variant; Args: TArguments);
procedure TCanvas_Write_Pen(const Value: Variant; Args: TArguments);

  { TGraphic }
procedure TGraphic_LoadFromFile(var Value: Variant; Args: TArguments);
procedure TGraphic_SaveToFile(var Value: Variant; Args: TArguments);
procedure TGraphic_LoadFromStream(var Value: Variant; Args: TArguments);
procedure TGraphic_SaveToStream(var Value: Variant; Args: TArguments);
procedure TGraphic_LoadFromClipboardFormat(var Value: Variant; Args: TArguments);
procedure TGraphic_SaveToClipboardFormat(var Value: Variant; Args: TArguments);
procedure TGraphic_Read_Empty(var Value: Variant; Args: TArguments);
procedure TGraphic_Read_Height(var Value: Variant; Args: TArguments);
procedure TGraphic_Write_Height(const Value: Variant; Args: TArguments);
procedure TGraphic_Read_Modified(var Value: Variant; Args: TArguments);
procedure TGraphic_Write_Modified(const Value: Variant; Args: TArguments);
procedure TGraphic_Read_Palette(var Value: Variant; Args: TArguments);
procedure TGraphic_Write_Palette(const Value: Variant; Args: TArguments);
procedure TGraphic_Read_PaletteModified(var Value: Variant; Args: TArguments);
procedure TGraphic_Write_PaletteModified(const Value: Variant; Args: TArguments);
procedure TGraphic_Read_Transparent(var Value: Variant; Args: TArguments);
procedure TGraphic_Write_Transparent(const Value: Variant; Args: TArguments);
procedure TGraphic_Read_Width(var Value: Variant; Args: TArguments);
procedure TGraphic_Write_Width(const Value: Variant; Args: TArguments);

  { TPicture }
procedure TPicture_Create(var Value: Variant; Args: TArguments);
procedure TPicture_LoadFromFile(var Value: Variant; Args: TArguments);
procedure TPicture_SaveToFile(var Value: Variant; Args: TArguments);
procedure TPicture_LoadFromClipboardFormat(var Value: Variant; Args: TArguments);
procedure TPicture_SaveToClipboardFormat(var Value: Variant; Args: TArguments);
procedure TPicture_SupportsClipboardFormat(var Value: Variant; Args: TArguments);
procedure TPicture_Assign(var Value: Variant; Args: TArguments);
procedure TPicture_Read_Bitmap(var Value: Variant; Args: TArguments);
procedure TPicture_Write_Bitmap(const Value: Variant; Args: TArguments);
procedure TPicture_Read_Graphic(var Value: Variant; Args: TArguments);
procedure TPicture_Write_Graphic(const Value: Variant; Args: TArguments);
procedure TPicture_Read_PictureAdapter(var Value: Variant; Args: TArguments);
procedure TPicture_Read_Height(var Value: Variant; Args: TArguments);
procedure TPicture_Read_Icon(var Value: Variant; Args: TArguments);
procedure TPicture_Write_Icon(const Value: Variant; Args: TArguments);
procedure TPicture_Read_Metafile(var Value: Variant; Args: TArguments);
procedure TPicture_Write_Metafile(const Value: Variant; Args: TArguments);
procedure TPicture_Read_Width(var Value: Variant; Args: TArguments);

  { TMetafile }
procedure TMetafile_Create(var Value: Variant; Args: TArguments);
procedure TMetafile_Clear(var Value: Variant; Args: TArguments);
procedure TMetafile_LoadFromStream(var Value: Variant; Args: TArguments);
procedure TMetafile_SaveToFile(var Value: Variant; Args: TArguments);
procedure TMetafile_SaveToStream(var Value: Variant; Args: TArguments);
procedure TMetafile_LoadFromClipboardFormat(var Value: Variant; Args: TArguments);
procedure TMetafile_SaveToClipboardFormat(var Value: Variant; Args: TArguments);
procedure TMetafile_Assign(var Value: Variant; Args: TArguments);
procedure TMetafile_ReleaseHandle(var Value: Variant; Args: TArguments);
procedure TMetafile_Read_CreatedBy(var Value: Variant; Args: TArguments);
procedure TMetafile_Read_Description(var Value: Variant; Args: TArguments);
procedure TMetafile_Read_Enhanced(var Value: Variant; Args: TArguments);
procedure TMetafile_Write_Enhanced(const Value: Variant; Args: TArguments);
procedure TMetafile_Read_Handle(var Value: Variant; Args: TArguments);
procedure TMetafile_Write_Handle(const Value: Variant; Args: TArguments);
procedure TMetafile_Read_MMWidth(var Value: Variant; Args: TArguments);
procedure TMetafile_Write_MMWidth(const Value: Variant; Args: TArguments);
procedure TMetafile_Read_MMHeight(var Value: Variant; Args: TArguments);
procedure TMetafile_Write_MMHeight(const Value: Variant; Args: TArguments);
procedure TMetafile_Read_Inch(var Value: Variant; Args: TArguments);
procedure TMetafile_Write_Inch(const Value: Variant; Args: TArguments);

  { TBitmap }
procedure TBitmap_Create(var Value: Variant; Args: TArguments);
procedure TBitmap_Assign(var Value: Variant; Args: TArguments);
procedure TBitmap_Dormant(var Value: Variant; Args: TArguments);
procedure TBitmap_FreeImage(var Value: Variant; Args: TArguments);
procedure TBitmap_LoadFromClipboardFormat(var Value: Variant; Args: TArguments);
procedure TBitmap_LoadFromStream(var Value: Variant; Args: TArguments);
procedure TBitmap_LoadFromResourceName(var Value: Variant; Args: TArguments);
procedure TBitmap_LoadFromResourceID(var Value: Variant; Args: TArguments);
procedure TBitmap_Mask(var Value: Variant; Args: TArguments);
procedure TBitmap_ReleaseHandle(var Value: Variant; Args: TArguments);
procedure TBitmap_ReleaseMaskHandle(var Value: Variant; Args: TArguments);
procedure TBitmap_ReleasePalette(var Value: Variant; Args: TArguments);
procedure TBitmap_SaveToClipboardFormat(var Value: Variant; Args: TArguments);
procedure TBitmap_SaveToStream(var Value: Variant; Args: TArguments);
procedure TBitmap_Read_Canvas(var Value: Variant; Args: TArguments);
procedure TBitmap_Read_Handle(var Value: Variant; Args: TArguments);
procedure TBitmap_Write_Handle(const Value: Variant; Args: TArguments);
procedure TBitmap_Read_HandleType(var Value: Variant; Args: TArguments);
procedure TBitmap_Write_HandleType(const Value: Variant; Args: TArguments);
procedure TBitmap_Read_IgnorePalette(var Value: Variant; Args: TArguments);
procedure TBitmap_Write_IgnorePalette(const Value: Variant; Args: TArguments);
procedure TBitmap_Read_MaskHandle(var Value: Variant; Args: TArguments);
procedure TBitmap_Read_Monochrome(var Value: Variant; Args: TArguments);
procedure TBitmap_Write_Monochrome(const Value: Variant; Args: TArguments);
procedure TBitmap_Read_PixelFormat(var Value: Variant; Args: TArguments);
procedure TBitmap_Write_PixelFormat(const Value: Variant; Args: TArguments);
procedure TBitmap_Read_ScanLine(var Value: Variant; Args: TArguments);
procedure TBitmap_Read_TransparentColor(var Value: Variant; Args: TArguments);
procedure TBitmap_Write_TransparentColor(const Value: Variant; Args: TArguments);
procedure TBitmap_Read_TransparentMode(var Value: Variant; Args: TArguments);
procedure TBitmap_Write_TransparentMode(const Value: Variant; Args: TArguments);

  { TIcon }
procedure TIcon_Create(var Value: Variant; Args: TArguments);
procedure TIcon_Assign(var Value: Variant; Args: TArguments);
procedure TIcon_LoadFromStream(var Value: Variant; Args: TArguments);
procedure TIcon_ReleaseHandle(var Value: Variant; Args: TArguments);
procedure TIcon_SaveToStream(var Value: Variant; Args: TArguments);
procedure TIcon_Read_Handle(var Value: Variant; Args: TArguments);
procedure TIcon_Write_Handle(const Value: Variant; Args: TArguments);
