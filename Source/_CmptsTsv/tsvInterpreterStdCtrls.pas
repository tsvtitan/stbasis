...
uses UMainUnited, tsvInterpreterCore;
  ...
  { TGroupBox }
procedure TGroupBox_Create(var Value: Variant; Args: TArguments);

  { TCustomLabel }
procedure TCustomLabel_Create(var Value: Variant; Args: TArguments);
procedure TCustomLabel_Read_Canvas(var Value: Variant; Args: TArguments);

  { TLabel }
procedure TLabel_Create(var Value: Variant; Args: TArguments);

  { TCustomEdit }
procedure TCustomEdit_Create(var Value: Variant; Args: TArguments);
procedure TCustomEdit_Clear(var Value: Variant; Args: TArguments);
procedure TCustomEdit_ClearSelection(var Value: Variant; Args: TArguments);
procedure TCustomEdit_CopyToClipboard(var Value: Variant; Args: TArguments);
procedure TCustomEdit_CutToClipboard(var Value: Variant; Args: TArguments);
procedure TCustomEdit_PasteFromClipboard(var Value: Variant; Args: TArguments);
procedure TCustomEdit_GetSelTextBuf(var Value: Variant; Args: TArguments);
procedure TCustomEdit_SelectAll(var Value: Variant; Args: TArguments);
procedure TCustomEdit_SetSelTextBuf(var Value: Variant; Args: TArguments);
procedure TCustomEdit_Read_Modified(var Value: Variant; Args: TArguments);
procedure TCustomEdit_Write_Modified(const Value: Variant; Args: TArguments);
procedure TCustomEdit_Read_SelLength(var Value: Variant; Args: TArguments);
procedure TCustomEdit_Write_SelLength(const Value: Variant; Args: TArguments);
procedure TCustomEdit_Read_SelStart(var Value: Variant; Args: TArguments);
procedure TCustomEdit_Write_SelStart(const Value: Variant; Args: TArguments);
procedure TCustomEdit_Read_SelText(var Value: Variant; Args: TArguments);
procedure TCustomEdit_Write_SelText(const Value: Variant; Args: TArguments);

  { TEdit }
procedure TEdit_Create(var Value: Variant; Args: TArguments);

  { TCustomMemo }
procedure TCustomMemo_Create(var Value: Variant; Args: TArguments);
procedure TCustomMemo_Read_Lines(var Value: Variant; Args: TArguments);
procedure TCustomMemo_Write_Lines(const Value: Variant; Args: TArguments);

  { TMemo }
procedure TMemo_Create(var Value: Variant; Args: TArguments);

  { TCustomComboBox }
procedure TCustomComboBox_Create(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_Clear(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_SelectAll(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_Read_Canvas(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_Read_DroppedDown(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_Write_DroppedDown(const Value: Variant; Args: TArguments);
procedure TCustomComboBox_Read_Items(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_Write_Items(const Value: Variant; Args: TArguments);
procedure TCustomComboBox_Read_ItemIndex(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_Write_ItemIndex(const Value: Variant; Args: TArguments);
procedure TCustomComboBox_Read_SelLength(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_Write_SelLength(const Value: Variant; Args: TArguments);
procedure TCustomComboBox_Read_SelStart(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_Write_SelStart(const Value: Variant; Args: TArguments);
procedure TCustomComboBox_Read_SelText(var Value: Variant; Args: TArguments);
procedure TCustomComboBox_Write_SelText(const Value: Variant; Args: TArguments);

  { TComboBox }
procedure TComboBox_Create(var Value: Variant; Args: TArguments);

  { TButton }
procedure TButton_Create(var Value: Variant; Args: TArguments);
procedure TButton_Click(var Value: Variant; Args: TArguments);

  { TCustomCheckBox }
procedure TCustomCheckBox_Create(var Value: Variant; Args: TArguments);

  { TCheckBox }
procedure TCheckBox_Create(var Value: Variant; Args: TArguments);

  { TRadioButton }
procedure TRadioButton_Create(var Value: Variant; Args: TArguments);

  { TCustomListBox }
procedure TCustomListBox_Create(var Value: Variant; Args: TArguments);
procedure TCustomListBox_Clear(var Value: Variant; Args: TArguments);
procedure TCustomListBox_Read_Canvas(var Value: Variant; Args: TArguments);
procedure TCustomListBox_Read_Items(var Value: Variant; Args: TArguments);
procedure TCustomListBox_Write_Items(const Value: Variant; Args: TArguments);
procedure TCustomListBox_Read_ItemIndex(var Value: Variant; Args: TArguments);
procedure TCustomListBox_Write_ItemIndex(const Value: Variant; Args: TArguments);
procedure TCustomListBox_Read_SelCount(var Value: Variant; Args: TArguments);
procedure TCustomListBox_Read_Selected(var Value: Variant; Args: TArguments);
procedure TCustomListBox_Write_Selected(const Value: Variant; Args: TArguments);
procedure TCustomListBox_Read_TopIndex(var Value: Variant; Args: TArguments);
procedure TCustomListBox_Write_TopIndex(const Value: Variant; Args: TArguments);

  { TListBox }
procedure TListBox_Create(var Value: Variant; Args: TArguments);

  { TScrollBar }
procedure TScrollBar_Create(var Value: Variant; Args: TArguments);
procedure TScrollBar_SetParams(var Value: Variant; Args: TArguments);

  { TCustomStaticText }
procedure TCustomStaticText_Create(var Value: Variant; Args: TArguments);

  { TStaticText }
procedure TStaticText_Create(var Value: Variant; Args: TArguments);
