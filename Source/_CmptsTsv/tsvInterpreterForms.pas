unit tsvInterpreterForms;

interface

uses SysUtils, Forms, UMainUnited, tsvInterpreterCore;

type
  TFormsEvent = class(TEvent)
  public
  ...
  { TControlScrollBar }
procedure TControlScrollBar_Assign(var Value: Variant; Args: TArguments);
procedure TControlScrollBar_Read_Kind(var Value: Variant; Args: TArguments);
procedure TControlScrollBar_Read_ScrollPos(var Value: Variant; Args: TArguments);
procedure TControlScrollBar_Read_Margin(var Value: Variant; Args: TArguments);
procedure TControlScrollBar_Write_Margin(const Value: Variant; Args: TArguments);
procedure TControlScrollBar_Read_Increment(var Value: Variant; Args: TArguments);
procedure TControlScrollBar_Write_Increment(const Value: Variant; Args: TArguments);
procedure TControlScrollBar_Read_Range(var Value: Variant; Args: TArguments);
procedure TControlScrollBar_Write_Range(const Value: Variant; Args: TArguments);
procedure TControlScrollBar_Read_Position(var Value: Variant; Args: TArguments);
procedure TControlScrollBar_Write_Position(const Value: Variant; Args: TArguments);
procedure TControlScrollBar_Read_Tracking(var Value: Variant; Args: TArguments);
procedure TControlScrollBar_Write_Tracking(const Value: Variant; Args: TArguments);
procedure TControlScrollBar_Read_Visible(var Value: Variant; Args: TArguments);
procedure TControlScrollBar_Write_Visible(const Value: Variant; Args: TArguments);

  { TScrollingWinControl }
procedure TScrollingWinControl_Create(var Value: Variant; Args: TArguments);
procedure TScrollingWinControl_DisableAutoRange(var Value: Variant; Args: TArguments);
procedure TScrollingWinControl_EnableAutoRange(var Value: Variant; Args: TArguments);
procedure TScrollingWinControl_ScrollInView(var Value: Variant; Args: TArguments);
procedure TScrollingWinControl_Read_HorzScrollBar(var Value: Variant; Args: TArguments);
procedure TScrollingWinControl_Write_HorzScrollBar(const Value: Variant; Args: TArguments);
procedure TScrollingWinControl_Read_VertScrollBar(var Value: Variant; Args: TArguments);
procedure TScrollingWinControl_Write_VertScrollBar(const Value: Variant; Args: TArguments);

  { TScrollBox }
procedure TScrollBox_Create(var Value: Variant; Args: TArguments);
procedure TScrollBox_Read_BorderStyle(var Value: Variant; Args: TArguments);
procedure TScrollBox_Write_BorderStyle(const Value: Variant; Args: TArguments);

  { TCustomForm }
procedure TCustomForm_CloseQuery(var Value: Variant; Args: TArguments);
procedure TCustomForm_Close(var Value: Variant; Args: TArguments);
procedure TCustomForm_DefocusControl(var Value: Variant; Args: TArguments);
procedure TCustomForm_FocusControl(var Value: Variant; Args: TArguments);
procedure TCustomForm_GetFormImage(var Value: Variant; Args: TArguments);
procedure TCustomForm_Hide(var Value: Variant; Args: TArguments);
procedure TCustomForm_Print(var Value: Variant; Args: TArguments);
procedure TCustomForm_Release(var Value: Variant; Args: TArguments);
procedure TCustomForm_SendCancelMode(var Value: Variant; Args: TArguments);
procedure TCustomForm_SetFocus(var Value: Variant; Args: TArguments);
procedure TCustomForm_SetFocusedControl(var Value: Variant; Args: TArguments);
procedure TCustomForm_Show(var Value: Variant; Args: TArguments);
procedure TCustomForm_ShowModal(var Value: Variant; Args: TArguments);
procedure TCustomForm_Read_Active(var Value: Variant; Args: TArguments);
procedure TCustomForm_Read_ActiveControl(var Value: Variant; Args: TArguments);
procedure TCustomForm_Write_ActiveControl(const Value: Variant; Args: TArguments);
procedure TCustomForm_Read_ActiveOleControl(var Value: Variant; Args: TArguments);
procedure TCustomForm_Write_ActiveOleControl(const Value: Variant; Args: TArguments);
procedure TCustomForm_Read_Canvas(var Value: Variant; Args: TArguments);
procedure TCustomForm_Read_DropTarget(var Value: Variant; Args: TArguments);
procedure TCustomForm_Write_DropTarget(const Value: Variant; Args: TArguments);
procedure TCustomForm_Read_HelpFile(var Value: Variant; Args: TArguments);
procedure TCustomForm_Write_HelpFile(const Value: Variant; Args: TArguments);
procedure TCustomForm_Read_KeyPreview(var Value: Variant; Args: TArguments);
procedure TCustomForm_Write_KeyPreview(const Value: Variant; Args: TArguments);
procedure TCustomForm_Read_Menu(var Value: Variant; Args: TArguments);
procedure TCustomForm_Write_Menu(const Value: Variant; Args: TArguments);
procedure TCustomForm_Read_ModalResult(var Value: Variant; Args: TArguments);
procedure TCustomForm_Write_ModalResult(const Value: Variant; Args: TArguments);
procedure TCustomForm_Read_WindowState(var Value: Variant; Args: TArguments);
procedure TCustomForm_Write_WindowState(const Value: Variant; Args: TArguments);

  { TForm }
procedure TForm_Create(var Value: Variant; Args: TArguments);
procedure TForm_CreateNew(var Value: Variant; Args: TArguments);
procedure TForm_ArrangeIcons(var Value: Variant; Args: TArguments);
procedure TForm_Cascade(var Value: Variant; Args: TArguments);
procedure TForm_Next(var Value: Variant; Args: TArguments);
procedure TForm_Previous(var Value: Variant; Args: TArguments);
procedure TForm_Tile(var Value: Variant; Args: TArguments);

  { TDataModule }
procedure TDataModule_Create(var Value: Variant; Args: TArguments);
procedure TDataModule_CreateNew(var Value: Variant; Args: TArguments);

  { TScreen }
procedure TScreen_Create(var Value: Variant; Args: TArguments);
procedure TScreen_Read_ActiveControl(var Value: Variant; Args: TArguments);
procedure TScreen_Read_ActiveCustomForm(var Value: Variant; Args: TArguments);
procedure TScreen_Read_ActiveForm(var Value: Variant; Args: TArguments);
procedure TScreen_Read_CustomFormCount(var Value: Variant; Args: TArguments);
procedure TScreen_Read_CustomForms(var Value: Variant; Args: TArguments);
procedure TScreen_Read_Cursor(var Value: Variant; Args: TArguments);
procedure TScreen_Write_Cursor(const Value: Variant; Args: TArguments);
procedure TScreen_Read_Cursors(var Value: Variant; Args: TArguments);
procedure TScreen_Write_Cursors(const Value: Variant; Args: TArguments);
procedure TScreen_Read_DataModules(var Value: Variant; Args: TArguments);
procedure TScreen_Read_DataModuleCount(var Value: Variant; Args: TArguments);
procedure TScreen_Read_IconFont(var Value: Variant; Args: TArguments);
procedure TScreen_Write_IconFont(const Value: Variant; Args: TArguments);
procedure TScreen_Read_Fonts(var Value: Variant; Args: TArguments);
procedure TScreen_Read_FormCount(var Value: Variant; Args: TArguments);
procedure TScreen_Read_Forms(var Value: Variant; Args: TArguments);
procedure TScreen_Read_Imes(var Value: Variant; Args: TArguments);
procedure TScreen_Read_DefaultIme(var Value: Variant; Args: TArguments);
procedure TScreen_Read_DefaultKbLayout(var Value: Variant; Args: TArguments);
procedure TScreen_Read_Height(var Value: Variant; Args: TArguments);
procedure TScreen_Read_PixelsPerInch(var Value: Variant; Args: TArguments);
procedure TScreen_Read_Width(var Value: Variant; Args: TArguments);

  { TApplication }
procedure TApplication_Create(var Value: Variant; Args: TArguments);
procedure TApplication_BringToFront(var Value: Variant; Args: TArguments);
procedure TApplication_ControlDestroyed(var Value: Variant; Args: TArguments);
procedure TApplication_CancelHint(var Value: Variant; Args: TArguments);
procedure TApplication_CreateForm(var Value: Variant; Args: TArguments);
procedure TApplication_HandleException(var Value: Variant; Args: TArguments);
procedure TApplication_HandleMessage(var Value: Variant; Args: TArguments);
procedure TApplication_HelpCommand(var Value: Variant; Args: TArguments);
procedure TApplication_HelpContext(var Value: Variant; Args: TArguments);
procedure TApplication_HelpJump(var Value: Variant; Args: TArguments);
procedure TApplication_HideHint(var Value: Variant; Args: TArguments);
procedure TApplication_Initialize(var Value: Variant; Args: TArguments);
procedure TApplication_MessageBox(var Value: Variant; Args: TArguments);
procedure TApplication_Minimize(var Value: Variant; Args: TArguments);
procedure TApplication_NormalizeAllTopMosts(var Value: Variant; Args: TArguments);
procedure TApplication_NormalizeTopMosts(var Value: Variant; Args: TArguments);
procedure TApplication_ProcessMessages(var Value: Variant; Args: TArguments);
procedure TApplication_Restore(var Value: Variant; Args: TArguments);
procedure TApplication_RestoreTopMosts(var Value: Variant; Args: TArguments);
procedure TApplication_Run(var Value: Variant; Args: TArguments);
procedure TApplication_ShowException(var Value: Variant; Args: TArguments);
procedure TApplication_Terminate(var Value: Variant; Args: TArguments);
procedure TApplication_Read_Active(var Value: Variant; Args: TArguments);
procedure TApplication_Read_CurrentHelpFile(var Value: Variant; Args: TArguments);
procedure TApplication_Read_DialogHandle(var Value: Variant; Args: TArguments);
procedure TApplication_Write_DialogHandle(const Value: Variant; Args: TArguments);
procedure TApplication_Read_ExeName(var Value: Variant; Args: TArguments);
procedure TApplication_Read_Handle(var Value: Variant; Args: TArguments);
procedure TApplication_Write_Handle(const Value: Variant; Args: TArguments);
procedure TApplication_Read_HelpFile(var Value: Variant; Args: TArguments);
procedure TApplication_Write_HelpFile(const Value: Variant; Args: TArguments);
procedure TApplication_Read_Hint(var Value: Variant; Args: TArguments);
procedure TApplication_Write_Hint(const Value: Variant; Args: TArguments);
procedure TApplication_Read_HintColor(var Value: Variant; Args: TArguments);
procedure TApplication_Write_HintColor(const Value: Variant; Args: TArguments);
procedure TApplication_Read_HintPause(var Value: Variant; Args: TArguments);
procedure TApplication_Write_HintPause(const Value: Variant; Args: TArguments);
procedure TApplication_Read_HintShortPause(var Value: Variant; Args: TArguments);
procedure TApplication_Write_HintShortPause(const Value: Variant; Args: TArguments);
procedure TApplication_Read_HintHidePause(var Value: Variant; Args: TArguments);
procedure TApplication_Write_HintHidePause(const Value: Variant; Args: TArguments);
procedure TApplication_Read_Icon(var Value: Variant; Args: TArguments);
procedure TApplication_Write_Icon(const Value: Variant; Args: TArguments);
procedure TApplication_Read_MainForm(var Value: Variant; Args: TArguments);
procedure TApplication_Read_ShowHint(var Value: Variant; Args: TArguments);
procedure TApplication_Write_ShowHint(const Value: Variant; Args: TArguments);
procedure TApplication_Read_ShowMainForm(var Value: Variant; Args: TArguments);
procedure TApplication_Write_ShowMainForm(const Value: Variant; Args: TArguments);
procedure TApplication_Read_Terminated(var Value: Variant; Args: TArguments);
procedure TApplication_Read_Title(var Value: Variant; Args: TArguments);
procedure TApplication_Write_Title(const Value: Variant; Args: TArguments);
procedure TApplication_Read_UpdateFormatSettings(var Value: Variant; Args: TArguments);
procedure TApplication_Write_UpdateFormatSettings(const Value: Variant; Args: TArguments);
procedure TApplication_Read_UpdateMetricSettings(var Value: Variant; Args: TArguments);
procedure TApplication_Write_UpdateMetricSettings(const Value: Variant; Args: TArguments);

procedure Forms_Application(var Value: Variant; Args: TArguments);
procedure Forms_Screen(var Value: Variant; Args: TArguments);
procedure Forms_GetParentForm(var Value: Variant; Args: TArguments);
procedure Forms_ValidParentForm(var Value: Variant; Args: TArguments);
procedure Forms_DisableTaskWindows(var Value: Variant; Args: TArguments);
procedure Forms_EnableTaskWindows(var Value: Variant; Args: TArguments);
procedure Forms_IsAccel(var Value: Variant; Args: TArguments);
procedure Forms_KeysToShiftState(var Value: Variant; Args: TArguments);
procedure Forms_KeyDataToShiftState(var Value: Variant; Args: TArguments);
procedure Forms_ForegroundTask(var Value: Variant; Args: TArguments);

implementation

uses
  Classes, Windows, Controls, Graphics, Menus, ImgList;

{ TFormsEvent }

procedure TFormsEvent.CloseEvent(Sender: TObject; var Action: TCloseAction);
begin
  CallFunction( [O2V(Sender), Action]);
  Action:=Args.Values[1];
end;

procedure TFormsEvent.CloseQueryEvent(Sender: TObject; var CanClose: Boolean);
begin
  CallFunction( [O2V(Sender), CanClose]);
  CanClose:=Args.Values[1];
end;

procedure TFormsEvent.ExceptionEvent(Sender: TObject; E: Exception);
begin
  CallFunction( [O2V(Sender), O2V(E)]);
end;

procedure TFormsEvent.IdleEvent(Sender: TObject; var Done: Boolean);
begin
  CallFunction( [O2V(Sender), Done]);
  Done:=Args.Values[1];
end;
...
type
  ...
  TFormsFormsEvent = class(TFormsEvent)
  private
    procedure CloseEvent(Sender: TObject; var Action: TCloseAction);
    procedure CloseQueryEvent(Sender: TObject; var CanClose: Boolean);
    procedure ExceptionEvent(Sender: TObject; E: Exception);
...
procedure TFormsFormsEvent.CloseEvent(Sender: TObject; var Action: TCloseAction);
begin
  CallFunction(nil, [O2V(Sender), Action]);
  Action := Args.Values[1];
end;

procedure TFormsFormsEvent.CloseQueryEvent(Sender: TObject; var CanClose: Boolean);
begin
  CallFunction(nil, [O2V(Sender), CanClose]);
  CanClose := Args.Values[1];
end;

procedure TFormsFormsEvent.ExceptionEvent(Sender: TObject; E: Exception);
begin
  CallFunction(nil, [O2V(Sender), O2V(E)]);
end;

procedure TFormsFormsEvent.IdleEvent(Sender: TObject; var Done: Boolean);
begin
  CallFunction(nil, [O2V(Sender), Done]);
  Done := Args.Values[1];
end;

procedure TFormsFormsEvent.ShowHintEvent(var HintStr: string; var CanShow: Boolean; var HintInfo: THintInfo);
begin
...
procedure RegisterFormsAdapter(FormsAdapter: TFormsAdapter);
begin
  with FormsAdapter do
  begin
   { TScrollBarKind }
   ...
   {$ENDIF RA_VCL}
    ...
    AddGet(TScreen, 'Forms', TScreen_Read_Forms, 1, [0], varEmpty);
   {$IFDEF RA_D3H}
   {$IFDEF RA_VCL}
...
//    AddGet(TApplication, 'Terminate', TApplication_Terminate, 0, [0], varEmpty);
   ...
   {$ENDIF RA_VCL}
    ...
    AddSrcVar('Forms','Application','TApplication',C2V(TApplication),O2V(Application));
    AddFun('Forms', 'Application', Forms_Application, 0, [0], varEmpty);
    AddFun('Forms', 'Screen', Forms_Screen, 0, [0], varEmpty);

    AddFun('Forms', 'GetParentForm', Forms_GetParentForm, 1, [varEmpty], varEmpty);
    AddFun('Forms', 'ValidParentForm', Forms_ValidParentForm, 1, [varEmpty], varEmpty);
   {$IFDEF RA_VCL}
    AddFun('Forms', 'DisableTaskWindows', Forms_DisableTaskWindows, 1, [varEmpty], varEmpty);
    AddFun('Forms', 'EnableTaskWindows', Forms_EnableTaskWindows, 1, [varEmpty], varEmpty);
   {$ENDIF RA_VCL}
    AddFun('Forms', 'IsAccel', Forms_IsAccel, 2, [varEmpty, varEmpty], varEmpty);
   {$IFDEF RA_VCL}
    AddFun('Forms', 'KeysToShiftState', Forms_KeysToShiftState, 1, [varEmpty], varEmpty);
    AddFun('Forms', 'KeyDataToShiftState', Forms_KeyDataToShiftState, 1, [varEmpty], varEmpty);
   {$IFDEF RA_D3H}
    AddFun('Forms', 'ForegroundTask', Forms_ForegroundTask, 0, [0], varEmpty);
   {$ENDIF RA_D3H}
   {$ENDIF RA_VCL}

    AddHandler('Forms', 'TCloseEvent', TFormsFormsEvent, @TFormsFormsEvent.CloseEvent);
    AddHandler('Forms', 'TCloseQueryEvent', TFormsFormsEvent, @TFormsFormsEvent.CloseQueryEvent);
    AddHandler('Forms', 'TExceptionEvent', TFormsFormsEvent, @TFormsFormsEvent.ExceptionEvent);
    AddHandler('Forms', 'TIdleEvent', TFormsFormsEvent, @TFormsFormsEvent.IdleEvent);
    AddHandler('Forms', 'TShowHintEvent', TFormsFormsEvent, @TFormsFormsEvent.ShowHintEvent);
  end;    { with }
  RegisterClasses([TScrollBox]);
end;    { RegisterFormsAdapter }
*)
