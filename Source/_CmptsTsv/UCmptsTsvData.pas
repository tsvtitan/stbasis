...
const
  ...
  ConstDesignPaletteNameInterface='Интерфейсы';
  ConstDesignPaletteHintInterface='Компоненты для работы с интерфейсами';

  ConstDesignPaletteNameStandart='Стандартные';
  ConstDesignPaletteHintStandart='Стандартные компоненты';

  ConstDesignPaletteNameAdditional='Дополнительные';
  ...
  ConstDesignPaletteNameSystem='Система';
  ConstDesignPaletteHintSystem='Системные компоненты';

  ConstDesignPaletteNameDialogs='Диалоги';
  ConstDesignPaletteHintDialogs='Диалоги';

  ConstDesignPaletteNameDataControls='База данных';
