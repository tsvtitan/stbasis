    ...
    object tsRptExport: TTabSheet
      ...
      object pnRptExport: TPanel
        ...
        object grbCaseExport: TGroupBox
          ...
          Width = 398
          Height = 136
          Caption = ' Варианты экспорта объявлений '
          TabOrder = 2
          object chbExportWithImport: TCheckBox
            ...
            Width = 247
            Height = 17
            Caption = 'Экспортировать рубрики согласно импорту'
            TabOrder = 0
          end
          object chbExportNoText: TCheckBox
            ...
            Width = 315
            Height = 17
            Caption = 'Экспортировать без ключевых слов и текста обьявления'
            TabOrder = 1
          end
          object chbExportUpperKeyWords: TCheckBox
            ...
            Width = 279
            Height = 17
            Caption = 'Приводить к верхнему регистру ключевые слова'
            Checked = True
            State = cbChecked
            TabOrder = 2
          end
          object chbExportWordKeyWithDelim: TCheckBox
            ...
            Width = 214
            Height = 17
            Hint = 'Разделять ключевые слова и текст объявления строкой'
            Caption = 'Разделять ключевые слова строкой'
          ...
          object chbAndText: TCheckBox
            ...
            Width = 109
            Height = 17
            Hint = 'и первого слова текста'
            Caption = 'и первого слова'
            Enabled = False
            TabOrder = 5
          end
        ...
        object chbExportWithAutoReplace: TCheckBox
          ...
          Width = 300
          Height = 17
          Caption = 'Применять правила автозамены для текста'
          TabOrder = 3
        end
      end
    end
      ...
      object pnSrvImport: TPanel
        ...
        object grbSrvImport: TGroupBox
          ...
          object lbBeforeContact: TLabel
            ...
            Width = 160
            Height = 13
            Caption = 'Перед контактным телефоном:'
          end
          object lbBeforeHome: TLabel
            ...
            Width = 152
            Height = 13
            Caption = 'Перед домашним телефоном:'
          end
          object lbBeforeWork: TLabel
            ...
            Width = 141
            Height = 13
            Caption = 'Перед рабочим телефоном:'
          end
        ...
        object chbImportWithOutKeyWords: TCheckBox
          ...
          Width = 371
          Height = 17
          Caption = 'Импортировать объявления без распознавания ключевых слов'
          TabOrder = 1
        end
        object chbImportLoadTranslateQuotas: TCheckBox
          ...
          Width = 395
          Height = 17
          Caption = 'Автоматически преобразовывать все двойные ковычки к общему виду'
          TabOrder = 2
        end
        object chbImportConvertWords: TCheckBox
          ...
          Width = 387
          Height = 17
          Caption = 'Конвертировать совпадающие английские буквы в русские'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 3
        end
        object chbImportSelectInvalidChar: TCheckBox
          ...
          Width = 387
          Height = 17
          Caption = 'Отображать красным цветов все символы, не входящие в список:'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 4
        end
    ...
    object tsRbkAnnouncement: TTabSheet
      ...
      object pnRbkAnnouncement: TPanel
        ...
        object lbPercentDouble: TLabel
          ...
          Width = 183
          Height = 13
          Caption = 'Минимальный процент совпадения:'
          Enabled = False
        end
        object chbAutoAdd: TCheckBox
          ...
          Width = 261
          Height = 17
          Caption = 'Автоматически открывать окно добавления'
          Checked = True
          State = cbChecked
          TabOrder = 0
        end
        object chbAutoOpenTree: TCheckBox
          ...
          Width = 319
          Height = 17
          Caption = 'Автоматически открывать окно рубрик при добалении'
          Checked = True
          State = cbChecked
          TabOrder = 1
        end
        object grbAnnouncementPhones: TGroupBox
          ...
          object lbAnnouncementNN: TLabel
            ...
            Width = 212
            Height = 13
            Caption = 'Количество цифр в городских телефонах:'
          end
        ...
        object chbAnnouncementTreePath: TCheckBox
          ...
          Width = 191
          Height = 17
          Caption = 'Показывать путь рубрикатора'
          Checked = True
          State = cbChecked
          TabOrder = 2
        ...
        object chbAnnouncementCheckRusWords: TCheckBox
          ...
          Width = 311
          Height = 17
          Caption = 'Автоматически проверять орфографию'
          Checked = True
          State = cbChecked
          TabOrder = 3
          OnClick = chbAnnouncementTreePathClick
        ...
        object chbAnnouncementDoStep95: TCheckBox
          ...
          Width = 311
          Height = 17
          Caption = 'Искать похожие объявления (не 100%)'
          Checked = True
          State = cbChecked
          TabOrder = 8
          Visible = False
        ...
        object chbAnnouncementViewDouble: TCheckBox
          ...
          Width = 175
          Height = 17
          Caption = 'Показывать панель дублей'
          TabOrder = 4
    ...
    object tsRptExportTreeHeading: TTabSheet
      ...
      object pnRptExportTreeHeading: TPanel
        ...
        object rgExportTreeHeading: TRadioGroup
          ...
          ItemIndex = 0
          Items.Strings = (
            'Для сторонних фирм и организаций'
