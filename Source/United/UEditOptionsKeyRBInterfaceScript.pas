unit UEditOptionsKeyRBInterfaceScript;
...
type
  TfmEditOptionsKeyRBInterfaceScript = class(TForm)
    pnBut: TPanel;
    Panel2: TPanel;
    bibOk: TButton;
    bibCancel: TButton;
...
var
  fmEditOptionsKeyRBInterfaceScript: TfmEditOptionsKeyRBInterfaceScript;
...
function TfmEditOptionsKeyRBInterfaceScript.CheckFieldsFill: Boolean;
begin
  Result:=true;
...
procedure TfmEditOptionsKeyRBInterfaceScript.bibOkClick(Sender: TObject);
begin
  if not CheckFieldsFill then exit;
  ModalResult:=mrOk;
end;

procedure TfmEditOptionsKeyRBInterfaceScript.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Application.hint:='';
end;

procedure TfmEditOptionsKeyRBInterfaceScript.FillCommands;
var
  i: Integer;
  P: PCommandHint;
begin
...
procedure TfmEditOptionsKeyRBInterfaceScript.FormCreate(Sender: TObject);
begin
  FillCommands;
  rgCaseClick(nil);
end;

procedure TfmEditOptionsKeyRBInterfaceScript.rgCaseClick(Sender: TObject);
begin
  case rgCase.ItemIndex of
    0: begin
