...
uses
  ...
  ExtCtrls, StdCtrls, ClipBrd, tsvListBox;
...
uses Consts, Dialogs, RACtlConst, RAStrUtil;
...
type
  TRAEditorCompletionList = class(TtsvListBox)
  private
    FTimer: TTimer;
    YY: integer;
...
begin
  ...
  FPopupList.Constraints.MinHeight:=ItemHeight*FDropDownCount;
