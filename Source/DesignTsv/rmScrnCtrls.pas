...
uses Windows, Messages, Controls, Classes, StdCtrls, ComCtrls, rmPathTreeView,Commctrl;
...
procedure TrmCustomScreenTreeView.WMSize(var Message: TWMSize); 
begin
  inherited;
...
procedure TrmCustomScreenTreeView.WMNCHitTest(var Message: TWMNCHitTest);
begin
  inherited;
  if not (csDesigning in ComponentState) and (Message.Result = HTSIZE) then
...
procedure TrmCustomScreenTreeView.KeyDown(var Key: Word; Shift: TShiftState);
begin
  inherited;
end;
