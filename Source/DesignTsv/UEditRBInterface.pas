  ...
  case TypeEditRBook of
     terbAdd: begin
      if Trim(edName.text)<>'' then
       Caption:=CaptionAdd+Format(' новый интерфейс <%s>',[edName.text])
      else Caption:=CaptionAdd+' новый интерфейс';
     end;
  end;
end;
  ...
  if (inherited TypeEditRBook)<>Value then begin
    case Value of
      terbAdd: begin
        ...
        Caption:=CaptionAdd+Format(' новый интерфейс',[]);
        tlbSaveToBaseScript.Enabled:=false;
        tlbSaveTobaseForms.Enabled:=false;
        tlbSaveToBaseDocuments.Enabled:=false;
      end;
      terbChange: begin
        pnMain.Align:=alClient;
        Caption:=CaptionChange+Format(' интерфейс <%s>',[InterfaceName]);
      ...
      terbView: begin
        pnMain.Align:=alClient;
        Caption:=CaptionView+Format(' об интерфейсе <%s>',[InterfaceName]);
        tlbSaveToBaseScript.Enabled:=false;
        tlbSaveTobaseForms.Enabled:=false;
        tlbSaveToBaseDocuments.Enabled:=false;
