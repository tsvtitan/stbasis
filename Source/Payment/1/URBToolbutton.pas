...
type
   TfmRBToolbutton = class(TfmRBMainGrid)
...
var
  fmRBToolbutton: TfmRBToolbutton;
...
procedure TfmRBToolbutton.FormCreate(Sender: TObject);
var
  cl: TColumn;
  ifl: TIntegerField;
  sfl: TStringField;
...
begin
 ...
 try
  ...
  ifl:=TIntegerField.Create(nil);
  ifl.FieldName:='sortvalue';
  ifl.DataSet:=Mainqr;

  cl:=Grid.Columns.Add;
  cl.Field:=ifl;
  cl.Title.Caption:='Порядок сортировки';
  cl.Width:=60;
...
procedure TfmRBToolbutton.FormDestroy(Sender: TObject);
begin
  inherited;
...
function TfmRBToolbutton.GetSql: string;
begin
...
procedure TfmRBToolbutton.ActiveQuery(CheckPerm: Boolean);
var
 sqls: String;
begin
 try
...
procedure TfmRBToolbutton.GridTitleClickWithSort(Column: TColumn; TypeSort: TTypeColumnSort);
var
  fn: string;
  id: string;
begin
...
procedure TfmRBToolbutton.GridDblClick(Sender: TObject);
begin
  if not Mainqr.Active then exit;
...
procedure TfmRBToolbutton.LoadFromIni;
begin
 inherited;
 try
...
procedure TfmRBToolbutton.SaveToIni;
begin
 inherited;
 try
...
procedure TfmRBToolbutton.bibRefreshClick(Sender: TObject);
begin
  ActiveQuery(true);
end;

procedure TfmRBToolbutton.bibAddClick(Sender: TObject);
var
...
procedure TfmRBToolbutton.bibChangeClick(Sender: TObject);
var
  fm: TfmEditRBToolbutton;
  ms: TMemoryStream;
begin
...
procedure TfmRBToolbutton.bibDelClick(Sender: TObject);
var
  but: Integer;
...
procedure TfmRBToolbutton.bibViewClick(Sender: TObject);
var
  fm: TfmEditRBToolbutton;
  ms: TMemoryStream;
begin
...
procedure TfmRBToolbutton.bibFilterClick(Sender: TObject);
var
  fm: TfmEditRBToolbutton;
  filstr: string;
begin
...
function TfmRBToolbutton.GetFilterString: string;
var
  FilInSide: string;
  wherestr: string;
...
procedure TfmRBToolbutton.MainqrCalcFields(DataSet: TDataSet);
begin
