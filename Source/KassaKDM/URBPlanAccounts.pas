...
uses UMainUnited, UKassaKDMCode, UKassaKDMDM, UKassaKDMData, UEditRBPlanAccounts,
  UFrameSubkonto;
...
begin
 try
  ...
  try
    ...
    IdRec := MainQr.FieldByName('PA_ID').AsInteger;
    fm.FrameSub.InitData(IdRec,'',true);
...
begin
 try
  ...
  try
    ...
    fm.FrameSub.InitData(MainQr.FieldByName('pa_id').AsInteger,'',true);
