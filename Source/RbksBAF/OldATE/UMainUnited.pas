...
{  ConstDBNavigatorWidth=60;
 ...
 //Added by Bespalov
  ...
  tbTown = 'Town';              NameTown='Справочник населенных пунктов';
  tbTypeStreet='typestreet';    NameTypeStreet='Справочник типов улиц';
  tbCountry='country';          NameCountry='Справочник стран';
  tbTypeRegion ='TypeRegion';   NameTypeRegion = 'Справочник типов краев и областей';
  tbTypeTown = 'TypeTown';      NameTypeTown = 'Справочник типов городов и населенных пунктов';
  ...
  tbState = 'State';            NameState='Справочник округов';
  ...
  tbTypePay='TypePay';        NameTypePay='Справочник видов оплат';
...
//    photo: Blob; 
  ...
  TAlgorithmParams=packed record
    ...
    amountmonthsback: Integer;
    totalamountmonths: Integer;
    typeamount: Integer;
    multiplyfactoraverage: Currency;
    divideamountperiod: Integer;
    salary: Currency;
    tariffrate: Currency;
    averagemonthsbonus: Currency;
    annualbonuses: Currency;
    minsalary: Currency;
    typeratetime: Integer;
    besiderowtable: Integer;
    percentadditionalcharge: Integer;
  end;
  ...
  TTownParams = packed record
    Town_id : integer;
    TownName:Array [0..DomainNameLength-1] of char;
    TypeTown_id: Integer; //Add Need params
    Region_id: integer;  //Add Need params
    State_id: integer;   //Add Need params
  end;

  PStreetParams=^TStreetParams;
  TStreetParams = packed record
    Street_id: integer;
    StreetName: Array [0..DomainNameLength-1] of char;
    TpStreet_id:integer;
    Town_id:integer;
  end;

  PTypeStreetParams=^TTypeStreetParams;
  TTypeStreetParams = packed record
    id : integer;
    Name: Array [0..DomainNameLength-1] of char;
  end;
  ...
  PTypeTownParams=^TTypeTownParams;
  TTypeTownParams = packed record
    id : integer;
    Name: Array [0..DomainNameLength-1] of char;
  end;

  PTypeRegionParams =^TTypeRegionParams;
  TTypeRegionParams = packed record
    id : integer;
    Name: Array [0..DomainNameLength-1] of char;
  end;
  ...
  TRegionParams = packed record
    id : integer;
    Code: Array [0..DomainSmallNameLength-1] of char;   //Add Need params
    Name: Array [0..DomainNameLength-1] of char;
    SmName:Array [0..DomainSmallNameLength-1] of char;  //Add Need params
    Country_id : integer;           //Add Need params
    TpRegion: integer;              //Add Need params
  end;
