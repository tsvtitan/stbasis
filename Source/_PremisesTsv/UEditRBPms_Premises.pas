...
type
  TTypeOperation=(toSale,toLease,toShare);
 ...
 try
  ...
  try
    ...
    sqls:='Insert into '+tbPms_Premises+
          ...
          'decoration,glassy,block_section,price2,advertisment_note'+
          ') values '+
          ' ('+id+
          ','+pms_typehouse_id+
          ','+pms_Stove_id+
...
var
  ...
  begin
    ...
    if (Control=edContact1)or
       ...
       (Control=edContact4)then Result:=true;
  end;
  ...
  begin
    ...
    if (isContact3 and isContact4)then or3:=' or ';
...
begin
  if TypeEditRBook in [terbAdd,terbChange] then begin
    cmbCityRegion.ItemIndex:=cmbCityRegion.Items.IndexOf(cmbCityRegion.Text);
    if (cmbRegion.ItemIndex<>-1) and (cmbCityRegion.ItemIndex=-1) then begin
