...
begin
 ...
 //CreateLocalPermission(hInterfaceRptPms_Price,tbPms_Regions_Correspond,ttpSelect,false);
  ...
  // CreateLocalPermission(hInterfaceRbkPms_Price,tbPms_Premises_Advertisment,ttpSelect,false);
 ...
 {  CreateLocalPermission(hInterfaceRbkPms_ImportPrice,tbPms_Advertisment,ttpSelect,false);
  ...
  // CreateLocalPermission(hInterfaceRptPms_ImportPrice,tbPms_City_Region,ttpSelect,false);
