    ...
    object tsGeneral: TTabSheet
      ...
      object pnGeneral: TPanel
        ...
        object chbLastOpen: TCheckBox
          ...
          Width = 201
          Height = 17
          Caption = 'Запоминать последнее состояние'
          TabOrder = 0
        end
        ...
        object chbMaximizeMainWindow: TCheckBox
          ...
          Width = 249
          Height = 17
          Caption = 'Открывать главное окно во весь экран'
          TabOrder = 3
        end
        ...
        object GroupBoxSplash: TGroupBox
          ...
          object CheckBoxVisbleSplashVersion: TCheckBox
            ...
            Width = 269
            Height = 17
            Caption = 'Отображать на заставке версию программы'
            TabOrder = 1
          end
          object CheckBoxVisibleSplashStatus: TCheckBox
            ...
            Width = 269
            Height = 17
            Caption = 'Отображать статусную строку на заставке'
            TabOrder = 2
          end
        end
      end
    ...
    object tsRBooks: TTabSheet
      ...
      object pnRBooks: TPanel
        ...
        object chbEditRBOnSelect: TCheckBox
          ...
          Width = 217
          Height = 17
          Caption = 'Редактировать данные при выборе'
          TabOrder = 0
        end
      end
    end
    object tsDirs: TTabSheet
      ...
      object pnDirs: TPanel
        ...
        object chbClearTempDir: TCheckBox
          ...
          Width = 217
          Height = 17
          Caption = 'Очищать при выходе из программы'
          Checked = True
          State = cbChecked
          TabOrder = 1
        end
    ...
    object tsLog: TTabSheet
      ...
      object pnLog: TPanel
        ...
        object lbLogLimit: TLabel
          ...
          Width = 149
          Height = 13
          Caption = 'Максимальный размер лога:'
        end
        object chbLogStayOnTop: TCheckBox
          ...
          Width = 169
          Height = 17
          Caption = 'Окно лога сверху всех окон'
          TabOrder = 0
        end
        object grbLog: TGroupBox
          ...
          Height = 164
          Align = alTop
          Caption = ' Вести лог сообщений типа '
          TabOrder = 1
        ...
        object chbLogViewDateTime: TCheckBox
          ...
          Width = 161
          Height = 17
          Caption = 'Показывать время и дату'
          TabOrder = 2
        end
      ...
      object pnSQLMonitor: TPanel
        ...
        object grbSqlMonitor: TGroupBox
          ...
          object chbSQLConnect: TCheckBox
            ...
            Width = 193
            Height = 17
            Caption = 'Соединение, отсоединение'
            Enabled = False
            TabOrder = 5
          end
          ...
          object chbSQLBlob: TCheckBox
            ...
            Width = 185
            Height = 17
            Caption = 'Операции с BLOB-полями'
            Enabled = False
            TabOrder = 7
          end
          ...
          object chbSQLMisc: TCheckBox
            ...
            Width = 249
            Height = 17
            Caption = 'Другие операции не перечисленные выше'
            Enabled = False
            TabOrder = 9
          end
        end
      ...
      object pnVisual: TPanel
        ...
        object grbVisualTable: TGroupBox
          ...
          object chbRBooksVisibleRowNumber: TCheckBox
            ...
            Width = 177
            Height = 17
            Caption = 'Показывать номер строки'
            TabOrder = 4
          end
        end
        object grbVisualForms: TGroupBox
          ...
          object lbColorElementFocus: TLabel
            ...
            Width = 137
            Height = 13
            Caption = 'Цвет елемента с фокусом:'
          end
          ...
          object chbViewFindPanel: TCheckBox
            ...
            Width = 177
            Height = 17
            Caption = 'Показывать панель поиска'
            TabOrder = 4
          end
          object chbViewEditPanel: TCheckBox
            ...
            Width = 212
            Height = 17
            Caption = 'Показывать панель редактирования'
            TabOrder = 5
          end
        ...
        object chbTypeFilter: TCheckBox
          ...
          Width = 361
          Height = 17
          Caption = 'Если выбрано, то фильтрация по условию <И>, иначе <ИЛИ>'
          TabOrder = 2
          Visible = False
        end
      end
