object frmSchedule: TfrmSchedule
  ...
  object PanelTop: TPanel
    ...
    object LookupCalendar: TRxLookupEdit
      Left = 120
      Top = 8
      Width = 289
      Height = 21
      LookupDisplay = 'startdatestr'
      LookupField = 'calendar_id'
      LookupSource = dsCalSelect
      DirectInput = False
      TabOrder = 0
    end
  ...
  object GridSchedule: TRxDBGrid
    ...
    TitleFont.Style = []
    OnDblClick = GridScheduleDblClick
  ...
  object Panel6: TPanel
    ...
    object GridNormalTime: TRxDBGrid
      ...
      IniStorage = FormStorage
      OnGetCellParams = GridNormalTimeGetCellParams
      OnEditChange = GridNormalTimeEditChange
    end
  ...
  object quNormalTimeSelect: TIBQuery
    Tag = 3
    Transaction = trRead
    AfterScroll = CommonAfterScroll
    BufferChunks = 1000
    ...
    SQL.Strings = (
        ...
        'select normaltime_id,schedule_id,shift_id,workdate,timecount fro' +
        'm normaltime where schedule_id=:schedule_id')
    Left = 156
    Top = 249
    ParamData = <
      item
